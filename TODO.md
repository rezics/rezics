...
- [ ] 定製 effect + db 的 console 輸出主題，可以做成獨立 package，包括信息輸出的中間件，可能需要討論一下，dev 和 production 都要支持，不過 production 是 log，然後要計入性能分析工具
...
- [ ] progress 是對長內容的記錄機制，對於 post / 單個 video 不能使用現有的 progress 系統
