...
- Community: Realm grouping/membership/governance, Collection curation and Zone page/subsite infrastructure; compose Zones with one or more Collections for wiki subsites, preserving publication relationships, native content identity, notifications and theme controls. Member administration must consume roster cursors through empty filtered pages and render nullable native Entity presentation. Private merge reviews must supply explicit source/target read-grant selections and handle revocation/expiry.
