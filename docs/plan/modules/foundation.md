...
- Integrate qualified participation controls with remaining Realm roster/disclosure, ownership and cross-module account-enforcement transitions, resource grants/restrictions and exact disclosure fences; prove ordered locks and current-snapshot rechecks across those paths.
