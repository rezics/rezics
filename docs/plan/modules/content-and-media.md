...
- Implement social Publication revisions, ContentSlot/Adoption, author release channels and independent editor/published/adopted heads across domains. Ordinary chapter/Post consumption follows context-eligible published heads; reviewed adoptions, precise citations and fixed releases pin exact content/structure; metadata-only states require no fabricated payload.
- Make chapter placement reuse an eligible Post and its Document without duplicating body, social identity or discussion. Preserve stable occurrence progress and declared published-channel selection.
