...
| --- | --- | --- | --- | --- |
| M01 | [Foundation](modules/foundation.md) | None | Defined; reference allocation protocol specified | G2 in progress: [identity reference primitive qualified](../testing/foundation.md); consumer cutover, exact references, authority and remaining contracts pending |
