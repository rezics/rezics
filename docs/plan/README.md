...
| --- | --- | --- | --- | --- | --- |
| M01 | [Foundation](modules/foundation.md) | None | Identity/access and adapter contracts selected | RoleBinding/representation persistence, native subject/path evaluation, assignment ceilings, atomic identity creation/main-choice APIs and credential-bound scope/role-definition APIs implemented; OAuth protocol schema generated; remaining management, App contracts, consumer/onboarding migration and recovery pending | G2 partial; new IAM/OAuth/default/ceiling/API work and artifact generators remain unqualified. Remaining [foundation](../testing/foundation.md) and [IAM/APP](../testing/identity-and-access.md) qualification pending. |
