...
| --- | --- | --- | --- | --- | --- |
| M01 | [Foundation](modules/foundation.md) | None | Identity/access and adapter contracts selected | RoleBinding storage/readers and representation grant storage/commands implemented; complete request/management policy, APIs and consumers pending | G2 partial; RoleBinding/readers, representation and typed migration generation remain unqualified. Remaining [foundation](../testing/foundation.md) and [IAM/APP](../testing/identity-and-access.md) qualification pending. |
