...
| M09 | [Search and operations](modules/search-and-operations.md) | M01 and participating module events | Defined; known runtime failures open | G2 in progress: [snapshot generations, failure/reclaim, activation, retention and runtime lifecycle qualified](../testing/recommendations.md); online disclosure, event delivery, capacity and restoration work pending |
