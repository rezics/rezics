...
| --- | --- | --- | --- | --- | --- |
| M01 | [Foundation](modules/foundation.md) | None | Identity/access and adapter contracts selected | RoleBinding/representation storage and readers, bounded representation path model implemented; complete request/management policy, APIs and consumers pending | G2 partial; RoleBinding/readers, representation/path model and typed migration generation remain unqualified. Remaining [foundation](../testing/foundation.md) and [IAM/APP](../testing/identity-and-access.md) qualification pending. |
