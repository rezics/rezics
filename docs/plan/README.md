...
| Phase | `repair`: native roster passes 433 assertions/211 HTTP requests, 22 schema tests, scoped TypeScript and document/design integrity. Continue recovery/capacity fixture reconciliation, native seed and private preference/default initialization without implicit Self. Full main integrity retains 55 type errors and the legacy preference bootstrap failure. |
