...
| --- | --- | --- | --- | --- | --- |
| M01 | [Foundation](modules/foundation.md) | None | Identity/access and adapter contracts selected | RoleBinding/representation persistence, native subject/path evaluation, assignment ceilings and private default storage/cleanup implemented; OAuth protocol schema generated; complete management, App contracts, APIs, consumer migration and recovery pending | G2 partial; new IAM/OAuth/default/ceiling work and artifact generators remain unqualified. Remaining [foundation](../testing/foundation.md) and [IAM/APP](../testing/identity-and-access.md) qualification pending. |
