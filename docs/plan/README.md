...
| --- | --- | --- | --- | --- |
| M01 | [Foundation](modules/foundation.md) | None | Defined; reference allocation protocol specified | G2 in progress: [canonical references and selected private-account lifecycle, Realm membership, participation, enforcement and authority protocols qualified](../testing/foundation.md); remaining consumers, revision/occurrence families, ownership/disclosure and other contracts pending |
