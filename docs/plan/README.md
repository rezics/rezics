...
Files under `pending-review/` are earlier proposals. Read their dates and verify current implementation before reusing them; their presence does not expand the current program or override its decisions.
