...
| --- | --- | --- | --- | --- |
| M01 | [Foundation](modules/foundation.md) | None | Defined; reference allocation protocol specified | G2 in progress: [reference persistence, Favorites/private Tag consumers and selected authority protocols qualified](../testing/foundation.md); remaining consumers, revision/occurrence families, ownership/disclosure and other contracts pending |
