...
| Authorization and secrets | Define delegated consent, per-operation authority, credential storage/rotation/revocation, tenant separation and public/private metadata boundaries. |
