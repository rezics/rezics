...
| access_scope | Stable authority key; exactly one registered platform root, concrete Org/Realm/Entity/private-account target or validated resource REF | Governing scope is explicit; private account targets are not promoted to public Unit references | Unique owner scope; target reverse |
