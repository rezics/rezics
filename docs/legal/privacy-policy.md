...
| Profile and preference data           | Public Profile fields and media, Profile address, interface and preferred content languages, content ratings, default publication license, feed-personalization setting, privacy settings, notification settings, blocked Profiles, and source preferences.                                                      |
| Public content and metadata           | Posts, Replies, Reviews, Wiki content, Units, localizations, titles, summaries, descriptions, Portable Text, images, links, tags, structures, variants, publication-license choices, and contribution or revision history.                                                                                       |
...
| Operate search, storage, delivery, and reliability systems  | Public content, metadata, media, search projections, request data, traces, metrics, and backups                                     | Perform our contract; our legitimate interest in operating and improving a reliable Service                                   |
...
| Public content and revision history                       | While published or needed to preserve attribution, content integrity, and license records; after removal, according to the applicable publication license, Unit Content License, and `[PUBLIC CONTENT RETENTION PERIOD]` |
