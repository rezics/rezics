...
GROUPS = {
    ...
    "D02": "access access-identity auth participation organization-membership account-control",
...
SQL_GROUPS = {
    ...
    "D02": "access-identity organization-membership participation-integrity participation-private-state unit-license-grant",
