...
GROUPS = {
    ...
    "D02": "access access-identity access-role access-membership access-group access-group-membership auth participation organization-membership account-control",
...
SQL_GROUPS = {
    ...
    "D02": "access-identity access-role access-membership access-group access-group-membership organization-membership participation-integrity participation-private-state unit-license-grant",
