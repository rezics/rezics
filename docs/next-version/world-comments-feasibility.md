...
The repository already contains an explicit [Unit reference contract](../../libraries/reference/src/index.ts), a [concrete-FK reference bridge](../../libraries/schema/src/postgres/knowledge/reference-value.ts), [owner-dispatched state reads](../../services/main/src/services/units/query.ts), and [Post/reply storage](../../libraries/schema/src/postgres/forum/post.ts). These establish ways to identify, resolve and discuss resources without a shared Unit parent row. The [Block registry](../../libraries/block/src/blocks.ts) and [Filter vocabulary](../../libraries/filter/src/unit.ts) still require a spatial extension; none of those files proves a spatial runtime exists.
