...
Auto-provision business user records on the server when authenticated users first access owner-level endpoints, using claims from the unified access token.
