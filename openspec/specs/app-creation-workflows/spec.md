# app-creation-workflows Specification

## Purpose

Defines the public app's content creation flows — guided, recoverable, and
policy-aware — covering type selection, existing-work/entity search, draft save,
validation, preview, publish/submit, and post-submit next actions. Creation
flows reuse shared contracts (`@rezics/contract`, `@rezics/api`), editor
primitives, UnitTranslation language controls, Unit attribution, tags, and
work-domain matching rather than duplicating DTOs or editor infrastructure.
