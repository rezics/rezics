# public-series-model Specification

## Purpose

Defines Series as a public-knowledge Unit extension, its contract-defined kind taxonomy, governance semantics, relation to Shelf, and Work display boundaries. A Series is catalog-maintained public knowledge backed by normal Unit infrastructure (translations, aliases, external references, permissions, and history), is release-first, and is distinct from user/system/community Shelf collections.
