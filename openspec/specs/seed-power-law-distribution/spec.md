# seed-power-law-distribution Specification

## Purpose

Define the power-law distribution primitive used by the seed factory and the per-domain count rules that depend on it. This capability ensures synthetic seed data exhibits realistic skew (most works receive few posts, a few receive many) instead of uniform output.
## Requirements
