# app-product-navigation Specification

## Purpose

Defines how the public app organizes navigation by user intent — discovery,
library, community, create, and personal areas — with signed-in/out visibility
rules, exclusion of test/diagnostic routes from production navigation, the realm
product information architecture (Feed default, About, moderator-only
Moderation), the rules for selecting the most specific chapter link route, and
the personal navigation area surfacing dashboard and drafts.
