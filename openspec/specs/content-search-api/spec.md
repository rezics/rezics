# content-search-api Specification

## Purpose

Defines the server-mediated content search API, including typed request
options, result envelopes, filtering, sorting, pagination, and index-backed
query behavior.
## Requirements
