# elysiajs-cors-integration Specification

## Purpose
CORS handling for Elysia services using the official `@elysiajs/cors` plugin. Provides app-level credentialed CORS with environment-aware origin allowlists, custom token header support, and automatic preflight handling.
