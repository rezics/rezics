...
Provide an in-memory user cache on the server to avoid redundant database lookups during permission resolution, with TTL aligned to the access token lifetime.
