# app-quality-states Specification

## Purpose

Defines the cross-cutting quality bar every production route in the public app
must meet: complete UI states (loading, empty, error, denied, not-found,
unauthenticated, success, plus reading-route deleted-node and empty-node
placeholders), adherence to Rezics design rules, WCAG 2.1 AA accessibility,
responsive layouts across primary breakpoints, and offline retry for
