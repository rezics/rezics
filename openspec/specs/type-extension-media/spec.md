# type-extension-media Specification

## Purpose

Defines the MEDIA Unit extension, media kind metadata, runtime and release
facts, content-structure integration, and work/release semantics.
## Requirements
