...
**Status**: Transient. May be deleted after `openspec/plans/design-system.md` reaches Phase 9.

This directory holds throwaway analysis output from Phase 1–2 of the design-system plan:

- `00-inventory.md` — Where the 72 reference design systems live in `../example/open-design/`.
