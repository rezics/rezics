...
- **WHEN** a user navigates to `/user/me/settings/profile` on a desktop viewport
...
- **THEN** the URL changes to `/user/me/settings/security` and the Security section content loads
...
- **WHEN** an unauthenticated user navigates to `/user/me/settings/profile`
- **THEN** they are redirected to the login page

### Requirement: Default route redirect
Navigating to `/user/me/settings` (no section) SHALL redirect to `/user/me/settings/profile`.

#### Scenario: Base settings URL redirects
- **WHEN** a user navigates to `/user/me/settings`
- **THEN** they are redirected to `/user/me/settings/profile`

### Requirement: Legacy edit route redirect
The legacy route `/user/me/edit` SHALL redirect to `/user/me/settings/profile`.
