...
- **New `@rezics/i18n` package**: Standalone shared package housing all translations, the typesafe-i18n generator output, formatters, and the React adapter.
...
- **Remove duplicate locale directories**: `package/app/src/locale/` and `package/admin/src/locale/` are consolidated into `@rezics/i18n`.
...
- `i18n-package`: Standalone `@rezics/i18n` package with typesafe-i18n generator, feature-based namespaces, lazy locale loading, and React adapter.
