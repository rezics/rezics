export const IntegrityConstraints = [
	...
	{ table: "account_follow_preference", name: "account_follow_preference_position_check" },
	{
		table: "content_structure_node",
	...
	{
		table: "account_realm_tag_subscription",
		name: "account_realm_tag_subscription_position_byte_length_check",
	},
	{ table: "realm_unit_tag", name: "realm_unit_tag_position_byte_length_check" },
	{ table: "account_unit_tag", name: "account_unit_tag_position_byte_length_check" },
	{
