...
DROP INDEX "account_enforcement_current_subject_idx";
CREATE INDEX "account_enforcement_current_subject_idx" ON "account_enforcement" ("auth_user_id","kind","id") WHERE "revocation_action_id" is null;
