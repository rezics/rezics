...
ALTER TABLE "schema_statement" ADD COLUMN "predicate_iri_hash" text NOT NULL;
ALTER TABLE "schema_statement" DROP CONSTRAINT "schema_statement_quad_key";
ALTER TABLE "schema_statement" ADD CONSTRAINT "schema_statement_quad_key" UNIQUE("release_id","subject_id","predicate_iri_hash","object_id","graph_id");
ALTER TABLE "schema_statement" ADD CONSTRAINT "schema_statement_predicate_hash" CHECK (encode(sha256(convert_to("predicate_iri",'UTF8')),'hex')="predicate_iri_hash");
