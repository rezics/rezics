...
-- Widen the bounded query contract to an OpenCC variant array. The PGroonga
-- index and stored documents do not change; only request-time matching changes.
...
DROP FUNCTION public.search_text_candidates(
