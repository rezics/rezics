...
-- Create "tag_public_position_stat" table
CREATE TABLE "tag_public_position_stat" (
  "tag_id" uuid NOT NULL,
  "public_position_count" bigint NOT NULL DEFAULT 0,
  "updated_at" timestamptz(3) NOT NULL DEFAULT now(),
  PRIMARY KEY ("tag_id"),
  CONSTRAINT "tag_public_position_stat_tag_id_fkey" FOREIGN KEY ("tag_id") REFERENCES "tag" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "tag_public_position_stat_count_check" CHECK (public_position_count >= 0)
);
