...
-- Drop index "account_favorite_target_idx" from table: "account_favorite"
DROP INDEX "account_favorite_target_idx";
-- Modify "account_favorite" table
ALTER TABLE "account_favorite" DROP CONSTRAINT "account_favorite_target_unit_id_check", DROP CONSTRAINT "account_favorite_target_unit_target_check", DROP CONSTRAINT "account_favorite_pkey", DROP COLUMN "target_unit_id", DROP COLUMN "target_owner", DROP COLUMN "target_unit_publishing_id", DROP COLUMN "target_unit_music_id", DROP COLUMN "target_unit_program_id", DROP COLUMN "target_unit_software_id", DROP COLUMN "target_unit_entity_id", DROP COLUMN "target_unit_grouping_id", DROP COLUMN "target_unit_reference_id", DROP COLUMN "target_unit_distribution_id", DROP COLUMN "target_unit_video_id", DROP COLUMN "target_unit_audio_id", DROP COLUMN "target_unit_post_id", DROP COLUMN "target_unit_poll_id", DROP COLUMN "target_unit_zone_id", DROP COLUMN "target_unit_realm_id", DROP COLUMN "target_unit_realm_rule_id", DROP COLUMN "target_unit_custom_theme_id", DROP COLUMN "target_unit_collection_id", DROP COLUMN "target_unit_tag_id", DROP COLUMN "target_unit_tag_path_id", DROP COLUMN "target_unit_label_id", ADD COLUMN "target_reference_id" uuid NOT NULL, ADD PRIMARY KEY ("auth_user_id", "target_reference_id"), ADD CONSTRAINT "account_favorite_target_reference_id_reference_value_id_fkey" FOREIGN KEY ("target_reference_id") REFERENCES "reference_value" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT;
-- Create index "account_favorite_target_idx" to table: "account_favorite"
CREATE INDEX "account_favorite_target_idx" ON "account_favorite" ("target_reference_id", "auth_user_id");
-- Drop index "account_favorite_revision_target_idx" from table: "account_favorite_revision"
DROP INDEX "account_favorite_revision_target_idx";
-- Drop index "account_favorite_revision_target_merge_idx" from table: "account_favorite_revision"
DROP INDEX "account_favorite_revision_target_merge_idx";
-- Modify "account_favorite_revision" table
ALTER TABLE "account_favorite_revision" DROP CONSTRAINT "account_favorite_revision_target_snapshot_check", DROP CONSTRAINT "account_favorite_revision_target_unit_id_check", DROP CONSTRAINT "account_favorite_revision_target_unit_target_check", DROP CONSTRAINT "account_favorite_revision_snapshot_check", ADD CONSTRAINT "account_favorite_revision_snapshot_check" CHECK (((operation = 'delete'::text) AND (snapshot IS NULL)) OR ((operation <> 'delete'::text) AND (snapshot IS NOT NULL) AND (jsonb_typeof(snapshot) = 'object'::text) AND (NOT (snapshot ? 'target'::text)) AND (octet_length((snapshot)::text) <= 98304))), DROP COLUMN "target_unit_id", DROP COLUMN "target_owner", DROP COLUMN "target_unit_publishing_id", DROP COLUMN "target_unit_music_id", DROP COLUMN "target_unit_program_id", DROP COLUMN "target_unit_software_id", DROP COLUMN "target_unit_entity_id", DROP COLUMN "target_unit_grouping_id", DROP COLUMN "target_unit_reference_id", DROP COLUMN "target_unit_distribution_id", DROP COLUMN "target_unit_video_id", DROP COLUMN "target_unit_audio_id", DROP COLUMN "target_unit_post_id", DROP COLUMN "target_unit_poll_id", DROP COLUMN "target_unit_zone_id", DROP COLUMN "target_unit_realm_id", DROP COLUMN "target_unit_realm_rule_id", DROP COLUMN "target_unit_custom_theme_id", DROP COLUMN "target_unit_collection_id", DROP COLUMN "target_unit_tag_id", DROP COLUMN "target_unit_tag_path_id", DROP COLUMN "target_unit_label_id", ADD COLUMN "target_reference_id" uuid NOT NULL, ADD CONSTRAINT "account_favorite_revision_2iWJVRxkfomi_fkey" FOREIGN KEY ("target_reference_id") REFERENCES "reference_value" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT;
-- Create index "account_favorite_revision_target_idx" to table: "account_favorite_revision"
CREATE INDEX "account_favorite_revision_target_idx" ON "account_favorite_revision" ("auth_user_id", "target_reference_id", "revision" DESC NULLS LAST);
-- Create index "account_favorite_revision_target_merge_idx" to table: "account_favorite_revision"
CREATE INDEX "account_favorite_revision_target_merge_idx" ON "account_favorite_revision" ("target_reference_id", "auth_user_id");
