...
CREATE TABLE "api_key_authority" (
	"id" uuid PRIMARY KEY,
	"user_id" uuid NOT NULL,
	"version" bigint DEFAULT 0 NOT NULL,
	"revoked_at" timestamp(3) with time zone,
	CONSTRAINT "api_key_authority_version_check" CHECK ("version" between 0 and 9007199254740991)
);

CREATE INDEX "api_key_authority_user_idx" ON "api_key_authority" ("user_id","id");
ALTER TABLE "api_key_authority" ADD CONSTRAINT "api_key_authority_user_id_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT;
ALTER TABLE "apikeys" ADD CONSTRAINT "apikeys_id_api_key_authority_id_fkey" FOREIGN KEY ("id") REFERENCES "api_key_authority"("id") ON DELETE RESTRICT;
