...
CREATE INDEX "access_role_binding_recipient_scope_idx" ON "access_role_binding" ("target_scope_id","recipient_scope_id","id") WHERE "state"='active' and "recipient_scope_id" is not null;
