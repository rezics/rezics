...
ALTER TABLE "access_representation" ADD COLUMN "parent_subject_id" uuid;
ALTER TABLE "access_representation" ADD COLUMN "parent_membership_id" uuid;
ALTER TABLE "access_representation" ADD COLUMN "parent_membership_generation" bigint;
ALTER TABLE "access_representation" ADD COLUMN "parent_selection_group_id" uuid;
ALTER TABLE "access_representation" ADD COLUMN "parent_selection_version" bigint;
CREATE INDEX "access_representation_parent_subject_idx" ON "access_representation" ("parent_subject_id","id") WHERE "parent_subject_id" is not null;
CREATE INDEX "access_representation_parent_admission_idx" ON "access_representation" ("parent_membership_id","parent_membership_generation","id") WHERE "parent_membership_id" is not null;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_parent_subject_id_access_subject_id_fkey" FOREIGN KEY ("parent_subject_id") REFERENCES "access_subject"("id") ON DELETE RESTRICT;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_parent_admission_fk" FOREIGN KEY ("parent_membership_id","parent_membership_generation") REFERENCES "access_membership_admission"("membership_id","generation") ON DELETE RESTRICT;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_parent_selection_fk" FOREIGN KEY ("parent_membership_id","parent_membership_generation","parent_selection_group_id","parent_selection_version") REFERENCES "access_group_membership_event"("membership_id","generation","group_id","version") ON DELETE RESTRICT;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_parent_basis_check" CHECK (
			("parent_grant_id" is null)=("parent_subject_id" is null)
			and ("parent_membership_id" is null)=("parent_membership_generation" is null)
			and ("parent_selection_group_id" is null)=("parent_selection_version" is null)
			and ("parent_membership_id" is null or ("parent_subject_id" is not null and "parent_membership_generation" between 1 and 9007199254740991))
			and ("parent_selection_group_id" is null or ("parent_membership_id" is not null and "parent_selection_version" between 1 and 9007199254740991)));
