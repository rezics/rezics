...
CREATE TABLE "access_representation" (
	...
	CONSTRAINT "access_representation_parent_check" CHECK (("parent_grant_id" is null and "parent_revision" is null) or ("parent_grant_id" is not null and "parent_grant_id"<>"id" and "parent_revision" is not null and "parent_revision" between 1 and 9007199254740991)),
	CONSTRAINT "access_representation_version_check" CHECK ("version" between 0 and 9007199254740991 and ("terms_revision" is null or "terms_revision" between 1 and "version")),
	CONSTRAINT "access_representation_state_check" CHECK (("state"='draft' and "terms_revision" is null) or ("state" in ('active','revoked') and "terms_revision" is not null)),
	CONSTRAINT "access_representation_recipient_check" CHECK (("recipient_kind"='subject' and "recipient_subject_id" is not null and "recipient_group_id" is null and "recipient_scope_id" is null) or ("recipient_kind"='group' and "recipient_subject_id" is null and "recipient_group_id" is not null and "recipient_scope_id" is not null) or ("recipient_kind"='all-members' and "recipient_subject_id" is null and "recipient_group_id" is null and "recipient_scope_id" is not null))
);

CREATE TABLE "access_representation_entity" (
	"entity_id" uuid PRIMARY KEY,
	"version" bigint DEFAULT 0 NOT NULL,
	CONSTRAINT "access_representation_entity_version_check" CHECK ("version" between 0 and 9007199254740991)
);

CREATE TABLE "access_representation_event" (
	"grant_id" uuid,
	"version" bigint,
...
CREATE TABLE "access_representation_revision" (
	...
	CONSTRAINT "access_representation_revision_pkey" PRIMARY KEY("grant_id","revision"),
	CONSTRAINT "access_representation_revision_eligibility_check" CHECK ((("membership_id" is null and "membership_generation" is null and "selection_group_id" is null and "selection_version" is null) or ("membership_id" is not null and "membership_generation" between 1 and 9007199254740991 and (("selection_group_id" is null and "selection_version" is null) or ("selection_group_id" is not null and "selection_version" between 1 and 9007199254740991)))) and ("membership_id" is null)=("membership_generation" is null) and ("selection_group_id" is null)=("selection_version" is null)),
	CONSTRAINT "access_representation_revision_path_check" CHECK (cardinality("target_path") between 0 and 8 and coalesce(array_ndims("target_path"),1)=1 and array_position("target_path",null) is null),
	CONSTRAINT "access_representation_revision_validity_check" CHECK (isfinite("valid_from") and ("valid_until" is null or (isfinite("valid_until") and "valid_until">"valid_from"))),
	CONSTRAINT "access_representation_revision_count_check" CHECK ("permission_count" between 0 and 82),
	CONSTRAINT "access_representation_revision_digest_check" CHECK ("permission_digest" ~ '^[0-9a-f]{64}$')
);

CREATE INDEX "access_representation_entity_idx" ON "access_representation" ("entity_id","target_scope_id","id");
CREATE INDEX "access_representation_target_idx" ON "access_representation" ("target_scope_id","entity_id","id");
CREATE INDEX "access_representation_recipient_scope_idx" ON "access_representation" ("target_scope_id","recipient_scope_id","id") WHERE "state"='active' and "recipient_scope_id" is not null;
CREATE INDEX "access_representation_parent_idx" ON "access_representation" ("parent_grant_id","parent_revision","id") WHERE "parent_grant_id" is not null;
CREATE INDEX "access_representation_subject_idx" ON "access_representation" ("recipient_subject_id","target_scope_id","id") WHERE "recipient_subject_id" is not null;
CREATE INDEX "access_representation_group_idx" ON "access_representation" ("recipient_group_id","target_scope_id","id") WHERE "recipient_group_id" is not null;
CREATE INDEX "access_representation_members_idx" ON "access_representation" ("recipient_scope_id","target_scope_id","id") WHERE "recipient_kind"='all-members';
CREATE UNIQUE INDEX "access_representation_event_operation_key" ON "access_representation_event" ("grant_id","operation_id");
CREATE INDEX "access_representation_revision_admission_idx" ON "access_representation_revision" ("membership_id","membership_generation","grant_id","revision") WHERE "membership_id" is not null;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_xx2ptQG29VCJ_fkey" FOREIGN KEY ("entity_id") REFERENCES "access_representation_entity"("entity_id") ON DELETE RESTRICT;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_target_scope_id_access_scope_id_fkey" FOREIGN KEY ("target_scope_id") REFERENCES "access_scope"("id") ON DELETE RESTRICT;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_E0UlxDshv4ST_fkey" FOREIGN KEY ("recipient_subject_id") REFERENCES "access_subject"("id") ON DELETE RESTRICT;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_recipient_scope_id_access_scope_id_fkey" FOREIGN KEY ("recipient_scope_id") REFERENCES "access_scope"("id") ON DELETE RESTRICT;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_group_scope_fk" FOREIGN KEY ("recipient_group_id","recipient_scope_id") REFERENCES "access_group"("id","scope_id") ON DELETE RESTRICT;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_terms_fk" FOREIGN KEY ("id","terms_revision") REFERENCES "access_representation_revision"("grant_id","revision") ON DELETE RESTRICT;
ALTER TABLE "access_representation" ADD CONSTRAINT "access_representation_parent_fk" FOREIGN KEY ("parent_grant_id","parent_revision") REFERENCES "access_representation_revision"("grant_id","revision") ON DELETE RESTRICT;
ALTER TABLE "access_representation_entity" ADD CONSTRAINT "access_representation_entity_entity_id_entity_identity_id_fkey" FOREIGN KEY ("entity_id") REFERENCES "entity_identity"("id") ON DELETE RESTRICT;
ALTER TABLE "access_representation_event" ADD CONSTRAINT "access_representation_event_N7YxdDfaHiWp_fkey" FOREIGN KEY ("grant_id") REFERENCES "access_representation"("id") ON DELETE RESTRICT;
ALTER TABLE "access_representation_event" ADD CONSTRAINT "access_representation_event_operator_auth_user_id_users_id_fkey" FOREIGN KEY ("operator_auth_user_id") REFERENCES "users"("id") ON DELETE RESTRICT;
ALTER TABLE "access_representation_event" ADD CONSTRAINT "access_representation_event_sa2LFG1u6AjA_fkey" FOREIGN KEY ("authority_subject_id") REFERENCES "access_subject"("id") ON DELETE RESTRICT;
ALTER TABLE "access_representation_event" ADD CONSTRAINT "access_representation_event_retained_terms_fk" FOREIGN KEY ("grant_id","retained_terms_revision") REFERENCES "access_representation_revision"("grant_id","revision") ON DELETE RESTRICT;
ALTER TABLE "access_representation_permission" ADD CONSTRAINT "access_representation_permission_revision_fk" FOREIGN KEY ("grant_id","revision") REFERENCES "access_representation_revision"("grant_id","revision") ON DELETE RESTRICT;
ALTER TABLE "access_representation_revision" ADD CONSTRAINT "access_representation_revision_admission_fk" FOREIGN KEY ("membership_id","membership_generation") REFERENCES "access_membership_admission"("membership_id","generation") ON DELETE RESTRICT;
ALTER TABLE "access_representation_revision" ADD CONSTRAINT "access_representation_revision_selection_fk" FOREIGN KEY ("membership_id","membership_generation","selection_group_id","selection_version") REFERENCES "access_group_membership_event"("membership_id","generation","group_id","version") ON DELETE RESTRICT;
ALTER TABLE "access_representation_revision" ADD CONSTRAINT "access_representation_revision_event_fk" FOREIGN KEY ("grant_id","revision") REFERENCES "access_representation_event"("grant_id","version") ON DELETE RESTRICT;
...
BEGIN
 ...
 IF TG_OP='INSERT' THEN
  ...
  RETURN NEW;
 END IF;
 IF ROW(NEW.id,NEW.target_scope_id,NEW.entity_id,NEW.parent_grant_id,NEW.parent_revision,NEW.recipient_kind,NEW.recipient_subject_id,NEW.recipient_group_id,NEW.recipient_scope_id) IS DISTINCT FROM ROW(OLD.id,OLD.target_scope_id,OLD.entity_id,OLD.parent_grant_id,OLD.parent_revision,OLD.recipient_kind,OLD.recipient_subject_id,OLD.recipient_group_id,OLD.recipient_scope_id) THEN RAISE EXCEPTION 'Representation identity cannot be retargeted' USING ERRCODE='55000'; END IF;
 ...
 IF NEW.state='active' THEN
  ...
  IF NEW.parent_grant_id IS NOT NULL THEN
   ...
   IF parent.entity_id IS DISTINCT FROM NEW.entity_id OR parent.target_scope_id IS DISTINCT FROM NEW.target_scope_id THEN RAISE EXCEPTION 'Dependent representation preserves Entity and target authority' USING ERRCODE='23514'; END IF;
