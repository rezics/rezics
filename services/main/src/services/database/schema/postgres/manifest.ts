...
> = {
	...
	following_reference_values: [
		"unit-reference-integrity.sql",
		"participation-follow.sql",
		"platform-aggregates.sql",
		"merge-integrity.sql",
	],
	recommendation_event_reference_values: [
		"unit-reference-integrity.sql",
		"participation-private-state.sql",
	],
	merge_review_authority: ["merge-integrity.sql"],
	realm_member_count_decrement: ["platform-aggregates.sql"],
	recommendation_exclusion_reference_values: [
		"unit-reference-integrity.sql",
		"merge-integrity.sql",
	],
	favorite_reference_values: [
		"reference-value.sql",
		"unit-reference-integrity.sql",
		"participation-private-state.sql",
	],
...
export const PostgreSqlSchemaFunctionNames = [
 ...
 "guard_access_assignment_receipt",
	...
	"guard_realm_enrollment_control",
	"guard_realm_enrollment_rule_consent",
	"guard_realm_enrollment_head",
	"validate_realm_enrollment_admission",
	"maintain_realm_membership_count",
	"maintain_realm_enforcement_count",
	"access_membership_is_eligible",
...
export const PostgreSqlSchemaTriggers = [
 ...
 { table: "access_assignment_receipt",name: "access_assignment_receipt_guard" },
	...
	{
		table: "access_role_binding_permission",
		name: "access_role_binding_permission_impact_truncate",
	},
	...
	{
		table: "access_assignment_ceiling_permission",
		name: "access_assignment_ceiling_permission_impact",
	},
	{
		table: "access_assignment_ceiling_permission",
		name: "access_assignment_ceiling_permission_impact_truncate",
	},
	...
	{
		table: "access_representation_revision",
		name: "access_representation_revision_impact_truncate",
	},
	{ table: "access_representation_permission", name: "access_representation_permission_impact" },
	{
		table: "access_representation_permission",
		name: "access_representation_permission_impact_truncate",
	},
	...
	{
		table: "connected_user_consent_representation",
		name: "connected_user_consent_representation_guard",
	},
	...
	{
		table: "access_assignment_ceiling_permission",
		name: "access_assignment_ceiling_permission_guard",
	},
	...
	).map((owner) => ({ table: `${owner}_identity`, name: `${owner}_merged_identity_write_guard` })),
	...
	{ table: "realm", name: "realm_enrollment_control" },
	{ table: "realm_enrollment", name: "realm_enrollment_guard" },
	{ table: "realm_enforcement", name: "realm_enforcement_guard" },
	{ table: "realm_enforcement", name: "realm_enforcement_count" },
	{ table: "access_membership_event", name: "realm_enrollment_admission" },
	{ table: "access_membership", name: "realm_membership_count" },
	{ table: "realm_enrollment_operation", name: "realm_enrollment_operation_immutable" },
	{ table: "realm_enrollment_rule_acceptance", name: "realm_enrollment_rule_immutable" },
	{ table: "realm_enrollment_rule_acceptance", name: "realm_enrollment_rule_consent_guard" },
...
export const PostgreSqlSchemaDynamicTriggers = [
	...
	...CatalogTriggerOwners.map((owner) => ({
		table: `${owner}_identity`,
		name: "zz_studio_catalog_creator_candidate",
	})),
	...[
		"post",
		"video",
...
export const PostgreSqlSchemaViews = [
	{
		name: "current_realm_entity_membership",
		relOptions: [],
		columns: [
	...
	{
		name: "current_realm_entity_rule_acceptance",
		relOptions: [],
		columns: [
