...
export const recommendationUnitStat = pgTable(
	"recommendation_unit_stat",
	{
		...
		dwell30s: integer("dwell_30s").default(0).notNull(),
		...
		highScores: integer().default(0).notNull(),
		activeProgress: integer().default(0).notNull(),
		completions: integer().default(0).notNull(),
		negativeProgress: integer().default(0).notNull(),
...
export const recommendationMetricDaily = pgTable(
	"recommendation_metric_daily",
	{
		...
		opens: integer().default(0).notNull(),
		dwell30s: integer("dwell_30s").default(0).notNull(),
		notInterested: integer().default(0).notNull(),
		createdAt: createCreatedAtColumn(),
	},
	(table) => [
