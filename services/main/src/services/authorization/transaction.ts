...
const denied = [InstallationDenied, OAuthClientSecretDenied, AppClientDenied, OAuthClientPolicyDenied, WorkloadPrincipalDenied, ConnectedAppDenied, CredentialAuthorityDenied, ManagementAuthorityDenied, AccessRoleAdmissionDenied,
...
const changed = [InstallationConflict, OAuthClientSecretConflict, AppClientConflict, WorkloadPrincipalConflict, ConnectedAppConflict, AccessRoleConflict, AccessRoleBindingConflict, AccessGroupConflict, AccessMembershipConflict,
	AccessGroupMembershipConflict, AccessRepresentationConflict, AccessAssignmentCeilingConflict, IdentityPreferenceConflict];
const unavailable = [InstallationUnavailable, OAuthClientSecretUnavailable, AppClientUnavailable, OAuthClientPolicyUnavailable, WorkloadPrincipalUnavailable, ConnectedAppUnavailable, AppCapabilitySnapshotUnavailable, CredentialAuthorityUnavailable, ManagementAuthorityUnavailable, AccessRoleAdmissionUnavailable,
