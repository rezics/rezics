...
import { accessAssignmentCeiling, accessAssignmentCeilingPermission, accessAssignmentCeilingEvent } from "@rezics/schema/postgres/access/access-assignment-ceiling";
