...
export type ContentLanguage = StaticDecode<typeof ContentLanguage>;
...
export type ContentLanguageTag = StaticDecode<typeof ContentLanguageTag>;

export const ContentLanguageChannel = t.UnionEnum(ContentLanguageChannelValues);
export type ContentLanguageChannel = StaticDecode<typeof ContentLanguageChannel>;
...
export type ContentLanguageSupportEntry = StaticDecode<typeof ContentLanguageSupportEntry>;
...
export type ContentLanguageSupport = StaticDecode<typeof ContentLanguageSupport>;
...
export type ChineseContentDisplay = StaticDecode<typeof ChineseContentDisplay>;
...
export type ContentRating = StaticDecode<typeof ContentRating>;
...
export type LocalizationLanguageHints = StaticDecode<typeof LocalizationLanguageHints>;
...
export type StoredUiLocale = StaticDecode<typeof StoredUiLocale>;
...
export type WorkReleaseStatus = StaticDecode<typeof WorkReleaseStatus>;
...
export type NonRealmUnitKind = StaticDecode<typeof NonRealmUnitKind>;
...
export type ResourceVisibility = StaticDecode<typeof ResourceVisibility>;

/** A registered License ID accepted and returned by the public API. */
export const License = t.UnionEnum(LicenseIds, {
	default: undefined,
});
export type License = StaticDecode<typeof License>;
...
export type Uuid = StaticDecode<typeof Uuid>;
...
export type RevisionContributionInput = StaticDecode<typeof RevisionContributionInput>;

export const RevisionContext = t.Object(
	{ contribution: t.Optional(RevisionContributionInput) },
	{ additionalProperties: false },
);
export type RevisionContext = StaticDecode<typeof RevisionContext>;
...
export type RevisionContextBody = StaticDecode<typeof RevisionContextBody>;
...
export type RevisionPrimaryContribution = StaticDecode<typeof RevisionPrimaryContribution>;
...
export type AvatarInput = StaticDecode<typeof AvatarInput>;
...
export type UnitIdParams = StaticDecode<typeof UnitIdParams>;
...
export type UnitLocalizationInput = StaticDecode<typeof UnitLocalizationInput>;
...
export type LifecycleInput = {
	[K in keyof typeof LifecycleInput]: StaticDecode<(typeof LifecycleInput)[K]>;
};
