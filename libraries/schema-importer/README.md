...
subsequent compilation is offline. Downloads are bounded and checked against the
committed SHA-256 pins before use. The full preparation command also generates the
