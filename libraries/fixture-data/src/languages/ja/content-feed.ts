...
export default {
	...
	realms: [
		{
			name: "とある魔術の禁書目録",
			initials: "禁",
			summary: "作品の世界観、登場人物、物語、思想的なテーマについて語り合います。",
		},
		{
			name: "集合知",
			initials: "集",
	...
	post: {
		title: "ミサカネットワークは、なぜ学園都市で最も特異な集合意識なのか？",
		body: "ミサカネットワークは、個々の意識を足し合わせただけのものではありません。電磁的な媒体によって個人の能力の限界を越えながら、それぞれの違いも保っています。",
