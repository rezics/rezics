...
import {
	...
	postApiGovernanceUnitByUnitIdOwnershipClaim,
	getApiGovernanceUnitByUnitIdAccessBindings,
	postApiGovernanceUnitByUnitIdAccessBindings,
	deleteApiGovernanceUnitByUnitIdAccessBindingsByBindingId,
	getApiGovernanceUnitByUnitIdAccessRestrictions,
	postApiGovernanceUnitByUnitIdAccessRestrictions,
	deleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionId,
	...
	deleteApiZonesByZoneIdPagesBySlug,
	getApiZonesByZoneIdNavigation,
	postApiZonesByZoneIdNavigation,
	getApiZonesByZoneIdNavigationByNavigationId,
	putApiZonesByZoneIdNavigationByNavigationId,
	...
	getApiSearchConfiguration,
	postApiSearchExecute,
	postApiSearchUnitsByUnitIdContentStructuresByStructureIdNodesByNodeIdExecute,
...
export const getApiGovernanceUnitByUnitIdAccessEffectiveQueryKey = ({
	path,
	query,
...
type GetApiGovernanceUnitByUnitIdAccessEffectiveQueryKey = ReturnType<
	typeof getApiGovernanceUnitByUnitIdAccessEffectiveQueryKey
>;

export function getApiGovernanceUnitByUnitIdAccessEffectiveQueryOptions(
	{ path, query }: GetApiGovernanceUnitByUnitIdAccessEffectiveOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiGovernanceUnitByUnitIdAccessEffectiveQueryKey({ path, query });
	return queryOptions<
		GetApiGovernanceUnitByUnitIdAccessEffectiveStatus200,
		ResponseErrorConfig<
			| GetApiGovernanceUnitByUnitIdAccessEffectiveStatus422
...
export function useGetApiGovernanceUnitByUnitIdAccessEffective<
	...
	TQueryData = GetApiGovernanceUnitByUnitIdAccessEffectiveStatus200,
	TQueryKey extends QueryKey = GetApiGovernanceUnitByUnitIdAccessEffectiveQueryKey,
>(
	{
		path,
		query,
		...
		path:
			| GetApiGovernanceUnitByUnitIdAccessEffectiveOptions["path"]
			| (() => GetApiGovernanceUnitByUnitIdAccessEffectiveOptions["path"]);
		query?:
			| GetApiGovernanceUnitByUnitIdAccessEffectiveOptions["query"]
			| (() => GetApiGovernanceUnitByUnitIdAccessEffectiveOptions["query"]);
	},
	options: {
		query?: Partial<
	...
	const queryKey =
		resolvedOptions?.queryKey ??
		getApiGovernanceUnitByUnitIdAccessEffectiveQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiGovernanceUnitByUnitIdAccessEffectiveQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export function putApiGovernanceUnitByUnitIdOwnershipMutationOptions<TContext = unknown>(
	...
	const mutationKey = putApiGovernanceUnitByUnitIdOwnershipMutationKey();
	return mutationOptions<
		PutApiGovernanceUnitByUnitIdOwnershipStatus200,
		ResponseErrorConfig<
			| PutApiGovernanceUnitByUnitIdOwnershipStatus403
...
export function usePutApiGovernanceUnitByUnitIdOwnership<TContext>(
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? putApiGovernanceUnitByUnitIdOwnershipMutationKey();

	const baseOptions = putApiGovernanceUnitByUnitIdOwnershipMutationOptions(
		config,
	) as UseMutationOptions<
		PutApiGovernanceUnitByUnitIdOwnershipStatus200,
		ResponseErrorConfig<
...
export const postApiGovernanceUnitByUnitIdOwnershipClaimMutationKey = () =>
	[{ url: "/api/governance/unit/:unitId/ownership/claim" }] as const;

export function postApiGovernanceUnitByUnitIdOwnershipClaimMutationOptions<TContext = unknown>(
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const mutationKey = postApiGovernanceUnitByUnitIdOwnershipClaimMutationKey();
	return mutationOptions<
		PostApiGovernanceUnitByUnitIdOwnershipClaimStatus200,
		ResponseErrorConfig<
			| PostApiGovernanceUnitByUnitIdOwnershipClaimStatus401
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await postApiGovernanceUnitByUnitIdOwnershipClaim({
				...config,
				path,
				body,
				throwOnError: true,
 ...
 */
export function usePostApiGovernanceUnitByUnitIdOwnershipClaim<TContext>(
	options: {
		mutation?: UseMutationOptions<
			PostApiGovernanceUnitByUnitIdOwnershipClaimStatus200,
			ResponseErrorConfig<
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? postApiGovernanceUnitByUnitIdOwnershipClaimMutationKey();

	const baseOptions = postApiGovernanceUnitByUnitIdOwnershipClaimMutationOptions(
		config,
	) as UseMutationOptions<
		PostApiGovernanceUnitByUnitIdOwnershipClaimStatus200,
		ResponseErrorConfig<
...
export const getApiGovernanceUnitByUnitIdAccessBindingsQueryKey = ({
	path,
}: Omit<GetApiGovernanceUnitByUnitIdAccessBindingsOptions, "headers">) =>
	[{ url: "/api/governance/unit/:unitId/access-bindings", params: path }] as const;

type GetApiGovernanceUnitByUnitIdAccessBindingsQueryKey = ReturnType<
	typeof getApiGovernanceUnitByUnitIdAccessBindingsQueryKey
>;

export function getApiGovernanceUnitByUnitIdAccessBindingsQueryOptions(
	{ path }: GetApiGovernanceUnitByUnitIdAccessBindingsOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiGovernanceUnitByUnitIdAccessBindingsQueryKey({ path });
	return queryOptions<
		GetApiGovernanceUnitByUnitIdAccessBindingsStatus200,
		ResponseErrorConfig<
			| GetApiGovernanceUnitByUnitIdAccessBindingsStatus403
	...
	>({
		queryKey,
		queryFn: async ({ signal }) => {
			const { data } = await getApiGovernanceUnitByUnitIdAccessBindings({
				...config,
				path,
				signal: config.signal ?? signal,
				throwOnError: true,
 ...
 */
export function useGetApiGovernanceUnitByUnitIdAccessBindings<
	TData = GetApiGovernanceUnitByUnitIdAccessBindingsStatus200,
	TQueryData = GetApiGovernanceUnitByUnitIdAccessBindingsStatus200,
	TQueryKey extends QueryKey = GetApiGovernanceUnitByUnitIdAccessBindingsQueryKey,
>(
	{
		path,
	}: {
		path:
			| GetApiGovernanceUnitByUnitIdAccessBindingsOptions["path"]
			| (() => GetApiGovernanceUnitByUnitIdAccessBindingsOptions["path"]);
	},
	options: {
		query?: Partial<
	...
	const queryKey =
		resolvedOptions?.queryKey ??
		getApiGovernanceUnitByUnitIdAccessBindingsQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiGovernanceUnitByUnitIdAccessBindingsQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export const postApiGovernanceUnitByUnitIdAccessBindingsMutationKey = () =>
	[{ url: "/api/governance/unit/:unitId/access-bindings" }] as const;

export function postApiGovernanceUnitByUnitIdAccessBindingsMutationOptions<TContext = unknown>(
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const mutationKey = postApiGovernanceUnitByUnitIdAccessBindingsMutationKey();
	return mutationOptions<
		PostApiGovernanceUnitByUnitIdAccessBindingsStatus200,
		ResponseErrorConfig<
			| PostApiGovernanceUnitByUnitIdAccessBindingsStatus400
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await postApiGovernanceUnitByUnitIdAccessBindings({
				...config,
				path,
				body,
				throwOnError: true,
 ...
 * {@link /api/governance/unit/:unitId/access-bindings}
 */
export function usePostApiGovernanceUnitByUnitIdAccessBindings<TContext>(
	options: {
		mutation?: UseMutationOptions<
			PostApiGovernanceUnitByUnitIdAccessBindingsStatus200,
			ResponseErrorConfig<
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? postApiGovernanceUnitByUnitIdAccessBindingsMutationKey();

	const baseOptions = postApiGovernanceUnitByUnitIdAccessBindingsMutationOptions(
		config,
	) as UseMutationOptions<
		PostApiGovernanceUnitByUnitIdAccessBindingsStatus200,
		ResponseErrorConfig<
...
export const deleteApiGovernanceUnitByUnitIdAccessBindingsByBindingIdMutationKey = () =>
	[{ url: "/api/governance/unit/:unitId/access-bindings/:bindingId" }] as const;

export function deleteApiGovernanceUnitByUnitIdAccessBindingsByBindingIdMutationOptions<
	TContext = unknown,
>(config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {}) {
	const mutationKey = deleteApiGovernanceUnitByUnitIdAccessBindingsByBindingIdMutationKey();
	return mutationOptions<
		DeleteApiGovernanceUnitByUnitIdAccessBindingsByBindingIdStatus204,
		ResponseErrorConfig<
			| DeleteApiGovernanceUnitByUnitIdAccessBindingsByBindingIdStatus403
	...
	>({
		mutationKey,
		mutationFn: async ({ path }) => {
			const { data } = await deleteApiGovernanceUnitByUnitIdAccessBindingsByBindingId({
				...config,
				path,
				throwOnError: true,
			});
 ...
 */
export function useDeleteApiGovernanceUnitByUnitIdAccessBindingsByBindingId<TContext>(
	options: {
		mutation?: UseMutationOptions<
			DeleteApiGovernanceUnitByUnitIdAccessBindingsByBindingIdStatus204,
			ResponseErrorConfig<
	...
	const mutationKey =
		mutationOptions.mutationKey ??
		deleteApiGovernanceUnitByUnitIdAccessBindingsByBindingIdMutationKey();

	const baseOptions = deleteApiGovernanceUnitByUnitIdAccessBindingsByBindingIdMutationOptions(
		config,
	) as UseMutationOptions<
		DeleteApiGovernanceUnitByUnitIdAccessBindingsByBindingIdStatus204,
		ResponseErrorConfig<
...
export const getApiGovernanceUnitByUnitIdAccessRestrictionsQueryKey = ({
	path,
}: Omit<GetApiGovernanceUnitByUnitIdAccessRestrictionsOptions, "headers">) =>
	[{ url: "/api/governance/unit/:unitId/access-restrictions", params: path }] as const;

type GetApiGovernanceUnitByUnitIdAccessRestrictionsQueryKey = ReturnType<
	typeof getApiGovernanceUnitByUnitIdAccessRestrictionsQueryKey
>;

export function getApiGovernanceUnitByUnitIdAccessRestrictionsQueryOptions(
	{ path }: GetApiGovernanceUnitByUnitIdAccessRestrictionsOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiGovernanceUnitByUnitIdAccessRestrictionsQueryKey({ path });
	return queryOptions<
		GetApiGovernanceUnitByUnitIdAccessRestrictionsStatus200,
		ResponseErrorConfig<
			| GetApiGovernanceUnitByUnitIdAccessRestrictionsStatus403
	...
	>({
		queryKey,
		queryFn: async ({ signal }) => {
			const { data } = await getApiGovernanceUnitByUnitIdAccessRestrictions({
				...config,
				path,
				signal: config.signal ?? signal,
				throwOnError: true,
 ...
 */
export function useGetApiGovernanceUnitByUnitIdAccessRestrictions<
	TData = GetApiGovernanceUnitByUnitIdAccessRestrictionsStatus200,
	TQueryData = GetApiGovernanceUnitByUnitIdAccessRestrictionsStatus200,
	TQueryKey extends QueryKey = GetApiGovernanceUnitByUnitIdAccessRestrictionsQueryKey,
>(
	{
		path,
	}: {
		path:
			| GetApiGovernanceUnitByUnitIdAccessRestrictionsOptions["path"]
			| (() => GetApiGovernanceUnitByUnitIdAccessRestrictionsOptions["path"]);
	},
	options: {
		query?: Partial<
	...
	const queryKey =
		resolvedOptions?.queryKey ??
		getApiGovernanceUnitByUnitIdAccessRestrictionsQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiGovernanceUnitByUnitIdAccessRestrictionsQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export const postApiGovernanceUnitByUnitIdAccessRestrictionsMutationKey = () =>
	[{ url: "/api/governance/unit/:unitId/access-restrictions" }] as const;

export function postApiGovernanceUnitByUnitIdAccessRestrictionsMutationOptions<TContext = unknown>(
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const mutationKey = postApiGovernanceUnitByUnitIdAccessRestrictionsMutationKey();
	return mutationOptions<
		PostApiGovernanceUnitByUnitIdAccessRestrictionsStatus200,
		ResponseErrorConfig<
			| PostApiGovernanceUnitByUnitIdAccessRestrictionsStatus400
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await postApiGovernanceUnitByUnitIdAccessRestrictions({
				...config,
				path,
				body,
				throwOnError: true,
...
export function usePostApiGovernanceUnitByUnitIdAccessRestrictions<TContext>(
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? postApiGovernanceUnitByUnitIdAccessRestrictionsMutationKey();

	const baseOptions = postApiGovernanceUnitByUnitIdAccessRestrictionsMutationOptions(
		config,
	) as UseMutationOptions<
		PostApiGovernanceUnitByUnitIdAccessRestrictionsStatus200,
		ResponseErrorConfig<
...
export const deleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionIdMutationKey = () =>
	[{ url: "/api/governance/unit/:unitId/access-restrictions/:restrictionId" }] as const;

export function deleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionIdMutationOptions<
	TContext = unknown,
>(config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {}) {
	const mutationKey =
		deleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionIdMutationKey();
	return mutationOptions<
		DeleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionIdStatus204,
		ResponseErrorConfig<
			| DeleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionIdStatus403
	...
	>({
		mutationKey,
		mutationFn: async ({ path }) => {
			const { data } = await deleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionId(
 ...
 */
export function useDeleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionId<TContext>(
	options: {
		mutation?: UseMutationOptions<
			DeleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionIdStatus204,
			ResponseErrorConfig<
	...
	const baseOptions =
		deleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionIdMutationOptions(
			config,
		) as UseMutationOptions<
			DeleteApiGovernanceUnitByUnitIdAccessRestrictionsByRestrictionIdStatus204,
			ResponseErrorConfig<
...
export const getApiGovernanceUnitByUnitIdProtectionsQueryKey = ({
	path,
}: Omit<GetApiGovernanceUnitByUnitIdProtectionsOptions, "headers">) =>
	[{ url: "/api/governance/unit/:unitId/protections", params: path }] as const;

type GetApiGovernanceUnitByUnitIdProtectionsQueryKey = ReturnType<
	typeof getApiGovernanceUnitByUnitIdProtectionsQueryKey
>;

export function getApiGovernanceUnitByUnitIdProtectionsQueryOptions(
	{ path }: GetApiGovernanceUnitByUnitIdProtectionsOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiGovernanceUnitByUnitIdProtectionsQueryKey({ path });
	return queryOptions<
		GetApiGovernanceUnitByUnitIdProtectionsStatus200,
		ResponseErrorConfig<
			| GetApiGovernanceUnitByUnitIdProtectionsStatus403
	...
	>({
		queryKey,
		queryFn: async ({ signal }) => {
			const { data } = await getApiGovernanceUnitByUnitIdProtections({
				...config,
				path,
				signal: config.signal ?? signal,
				throwOnError: true,
 ...
 */
export function useGetApiGovernanceUnitByUnitIdProtections<
	TData = GetApiGovernanceUnitByUnitIdProtectionsStatus200,
	TQueryData = GetApiGovernanceUnitByUnitIdProtectionsStatus200,
	TQueryKey extends QueryKey = GetApiGovernanceUnitByUnitIdProtectionsQueryKey,
>(
	{
		path,
	}: {
		path:
			| GetApiGovernanceUnitByUnitIdProtectionsOptions["path"]
			| (() => GetApiGovernanceUnitByUnitIdProtectionsOptions["path"]);
	},
	options: {
		query?: Partial<
	...
	const queryKey =
		resolvedOptions?.queryKey ??
		getApiGovernanceUnitByUnitIdProtectionsQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiGovernanceUnitByUnitIdProtectionsQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export const postApiGovernanceUnitByUnitIdProtectionsMutationKey = () =>
	[{ url: "/api/governance/unit/:unitId/protections" }] as const;

export function postApiGovernanceUnitByUnitIdProtectionsMutationOptions<TContext = unknown>(
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const mutationKey = postApiGovernanceUnitByUnitIdProtectionsMutationKey();
	return mutationOptions<
		PostApiGovernanceUnitByUnitIdProtectionsStatus200,
		ResponseErrorConfig<
			| PostApiGovernanceUnitByUnitIdProtectionsStatus400
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await postApiGovernanceUnitByUnitIdProtections({
				...config,
				path,
				body,
				throwOnError: true,
 ...
 * {@link /api/governance/unit/:unitId/protections}
 */
export function usePostApiGovernanceUnitByUnitIdProtections<TContext>(
	options: {
		mutation?: UseMutationOptions<
			PostApiGovernanceUnitByUnitIdProtectionsStatus200,
			ResponseErrorConfig<
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? postApiGovernanceUnitByUnitIdProtectionsMutationKey();

	const baseOptions = postApiGovernanceUnitByUnitIdProtectionsMutationOptions(
		config,
	) as UseMutationOptions<
		PostApiGovernanceUnitByUnitIdProtectionsStatus200,
		ResponseErrorConfig<
...
export const deleteApiGovernanceUnitByUnitIdProtectionsByProtectionIdMutationKey = () =>
	[{ url: "/api/governance/unit/:unitId/protections/:protectionId" }] as const;

export function deleteApiGovernanceUnitByUnitIdProtectionsByProtectionIdMutationOptions<
	TContext = unknown,
>(config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {}) {
	const mutationKey = deleteApiGovernanceUnitByUnitIdProtectionsByProtectionIdMutationKey();
	return mutationOptions<
		DeleteApiGovernanceUnitByUnitIdProtectionsByProtectionIdStatus204,
		ResponseErrorConfig<
			| DeleteApiGovernanceUnitByUnitIdProtectionsByProtectionIdStatus403
	...
	>({
		mutationKey,
		mutationFn: async ({ path }) => {
			const { data } = await deleteApiGovernanceUnitByUnitIdProtectionsByProtectionId({
				...config,
				path,
				throwOnError: true,
			});
 ...
 */
export function useDeleteApiGovernanceUnitByUnitIdProtectionsByProtectionId<TContext>(
	options: {
		mutation?: UseMutationOptions<
			DeleteApiGovernanceUnitByUnitIdProtectionsByProtectionIdStatus204,
			ResponseErrorConfig<
	...
	const mutationKey =
		mutationOptions.mutationKey ??
		deleteApiGovernanceUnitByUnitIdProtectionsByProtectionIdMutationKey();

	const baseOptions = deleteApiGovernanceUnitByUnitIdProtectionsByProtectionIdMutationOptions(
		config,
	) as UseMutationOptions<
		DeleteApiGovernanceUnitByUnitIdProtectionsByProtectionIdStatus204,
		ResponseErrorConfig<
...
export function useGetApiZonesByZoneId<
	...
	TQueryData = GetApiZonesByZoneIdStatus200,
	TQueryKey extends QueryKey = GetApiZonesByZoneIdQueryKey,
>(
	{
		path,
		query,
	...
	const queryResult = useQuery(
		{
			...getApiZonesByZoneIdQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export function patchApiZonesByZoneIdMutationOptions<TContext = unknown>(
	...
	const mutationKey = patchApiZonesByZoneIdMutationKey();
	return mutationOptions<
		PatchApiZonesByZoneIdStatus200,
		ResponseErrorConfig<
			| PatchApiZonesByZoneIdStatus400
...
export function usePatchApiZonesByZoneId<TContext>(
	...
	const { mutation = {}, client: config = {} } = options ?? {};
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey = mutationOptions.mutationKey ?? patchApiZonesByZoneIdMutationKey();

	const baseOptions = patchApiZonesByZoneIdMutationOptions(config) as UseMutationOptions<
		PatchApiZonesByZoneIdStatus200,
		ResponseErrorConfig<
			| PatchApiZonesByZoneIdStatus400
			| PatchApiZonesByZoneIdStatus403
...
export const getApiZonesByZoneIdPagesBySlugQueryKey = ({
	path,
}: Omit<GetApiZonesByZoneIdPagesBySlugOptions, "headers">) =>
	[{ url: "/api/zones/:zoneId/pages/:slug", params: path }] as const;

type GetApiZonesByZoneIdPagesBySlugQueryKey = ReturnType<
	typeof getApiZonesByZoneIdPagesBySlugQueryKey
>;

export function getApiZonesByZoneIdPagesBySlugQueryOptions(
	{ path }: GetApiZonesByZoneIdPagesBySlugOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiZonesByZoneIdPagesBySlugQueryKey({ path });
	return queryOptions<
		GetApiZonesByZoneIdPagesBySlugStatus200,
		ResponseErrorConfig<
			| GetApiZonesByZoneIdPagesBySlugStatus404
	...
	>({
		queryKey,
		queryFn: async ({ signal }) => {
			const { data } = await getApiZonesByZoneIdPagesBySlug({
				...config,
				path,
				signal: config.signal ?? signal,
				throwOnError: true,
 ...
 */
export function useGetApiZonesByZoneIdPagesBySlug<
	TData = GetApiZonesByZoneIdPagesBySlugStatus200,
	TQueryData = GetApiZonesByZoneIdPagesBySlugStatus200,
	TQueryKey extends QueryKey = GetApiZonesByZoneIdPagesBySlugQueryKey,
>(
	{
		path,
	}: {
		path:
			| GetApiZonesByZoneIdPagesBySlugOptions["path"]
			| (() => GetApiZonesByZoneIdPagesBySlugOptions["path"]);
	},
	options: {
		query?: Partial<
	...
	const resolvedParams = { path: typeof path === "function" ? path() : path };
	const queryKey =
		resolvedOptions?.queryKey ?? getApiZonesByZoneIdPagesBySlugQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiZonesByZoneIdPagesBySlugQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export const putApiZonesByZoneIdPagesBySlugMutationKey = () =>
	[{ url: "/api/zones/:zoneId/pages/:slug" }] as const;

export function putApiZonesByZoneIdPagesBySlugMutationOptions<TContext = unknown>(
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const mutationKey = putApiZonesByZoneIdPagesBySlugMutationKey();
	return mutationOptions<
		PutApiZonesByZoneIdPagesBySlugStatus200,
		ResponseErrorConfig<
			| PutApiZonesByZoneIdPagesBySlugStatus400
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await putApiZonesByZoneIdPagesBySlug({
				...config,
				path,
				body,
				throwOnError: true,
 ...
 * {@link /api/zones/:zoneId/pages/:slug}
 */
export function usePutApiZonesByZoneIdPagesBySlug<TContext>(
	options: {
		mutation?: UseMutationOptions<
			PutApiZonesByZoneIdPagesBySlugStatus200,
			ResponseErrorConfig<
	...
	const { mutation = {}, client: config = {} } = options ?? {};
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey = mutationOptions.mutationKey ?? putApiZonesByZoneIdPagesBySlugMutationKey();

	const baseOptions = putApiZonesByZoneIdPagesBySlugMutationOptions(config) as UseMutationOptions<
		PutApiZonesByZoneIdPagesBySlugStatus200,
		ResponseErrorConfig<
			| PutApiZonesByZoneIdPagesBySlugStatus400
			| PutApiZonesByZoneIdPagesBySlugStatus403
...
export const deleteApiZonesByZoneIdPagesBySlugMutationKey = () =>
	[{ url: "/api/zones/:zoneId/pages/:slug" }] as const;

export function deleteApiZonesByZoneIdPagesBySlugMutationOptions<TContext = unknown>(
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const mutationKey = deleteApiZonesByZoneIdPagesBySlugMutationKey();
	return mutationOptions<
		DeleteApiZonesByZoneIdPagesBySlugStatus204,
		ResponseErrorConfig<
			| DeleteApiZonesByZoneIdPagesBySlugStatus403
	...
	>({
		mutationKey,
		mutationFn: async ({ path }) => {
			const { data } = await deleteApiZonesByZoneIdPagesBySlug({
				...config,
				path,
				throwOnError: true,
			});
 ...
 * {@link /api/zones/:zoneId/pages/:slug}
 */
export function useDeleteApiZonesByZoneIdPagesBySlug<TContext>(
	options: {
		mutation?: UseMutationOptions<
			DeleteApiZonesByZoneIdPagesBySlugStatus204,
			ResponseErrorConfig<
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? deleteApiZonesByZoneIdPagesBySlugMutationKey();

	const baseOptions = deleteApiZonesByZoneIdPagesBySlugMutationOptions(
		config,
	) as UseMutationOptions<
		DeleteApiZonesByZoneIdPagesBySlugStatus204,
		ResponseErrorConfig<
...
export function getApiZonesByZoneIdNavigationQueryOptions(
	{ path }: GetApiZonesByZoneIdNavigationOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiZonesByZoneIdNavigationQueryKey({ path });
	return queryOptions<
		GetApiZonesByZoneIdNavigationStatus200,
		ResponseErrorConfig<
			| GetApiZonesByZoneIdNavigationStatus404
...
export function useGetApiZonesByZoneIdNavigation<
	...
	TQueryData = GetApiZonesByZoneIdNavigationStatus200,
	TQueryKey extends QueryKey = GetApiZonesByZoneIdNavigationQueryKey,
>(
	{
		path,
	}: {
		path:
			| GetApiZonesByZoneIdNavigationOptions["path"]
			| (() => GetApiZonesByZoneIdNavigationOptions["path"]);
	},
	options: {
		query?: Partial<
	...
	const resolvedParams = { path: typeof path === "function" ? path() : path };
	const queryKey =
		resolvedOptions?.queryKey ?? getApiZonesByZoneIdNavigationQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiZonesByZoneIdNavigationQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export function postApiZonesByZoneIdNavigationMutationOptions<TContext = unknown>(
	...
	const mutationKey = postApiZonesByZoneIdNavigationMutationKey();
	return mutationOptions<
		PostApiZonesByZoneIdNavigationStatus200,
		ResponseErrorConfig<
			| PostApiZonesByZoneIdNavigationStatus400
...
export function usePostApiZonesByZoneIdNavigation<TContext>(
	...
	const { mutation = {}, client: config = {} } = options ?? {};
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey = mutationOptions.mutationKey ?? postApiZonesByZoneIdNavigationMutationKey();

	const baseOptions = postApiZonesByZoneIdNavigationMutationOptions(config) as UseMutationOptions<
		PostApiZonesByZoneIdNavigationStatus200,
		ResponseErrorConfig<
			| PostApiZonesByZoneIdNavigationStatus400
			| PostApiZonesByZoneIdNavigationStatus403
...
export function getApiZonesByZoneIdNavigationByNavigationIdQueryOptions(
	{ path }: GetApiZonesByZoneIdNavigationByNavigationIdOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiZonesByZoneIdNavigationByNavigationIdQueryKey({ path });
	return queryOptions<
		GetApiZonesByZoneIdNavigationByNavigationIdStatus200,
		ResponseErrorConfig<
			| GetApiZonesByZoneIdNavigationByNavigationIdStatus404
...
export function useGetApiZonesByZoneIdNavigationByNavigationId<
	...
	TQueryData = GetApiZonesByZoneIdNavigationByNavigationIdStatus200,
	TQueryKey extends QueryKey = GetApiZonesByZoneIdNavigationByNavigationIdQueryKey,
>(
	{
		path,
	}: {
		path:
			| GetApiZonesByZoneIdNavigationByNavigationIdOptions["path"]
			| (() => GetApiZonesByZoneIdNavigationByNavigationIdOptions["path"]);
	},
	options: {
		query?: Partial<
	...
	const queryKey =
		resolvedOptions?.queryKey ??
		getApiZonesByZoneIdNavigationByNavigationIdQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiZonesByZoneIdNavigationByNavigationIdQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export function putApiZonesByZoneIdNavigationByNavigationIdMutationOptions<TContext = unknown>(
	...
	const mutationKey = putApiZonesByZoneIdNavigationByNavigationIdMutationKey();
	return mutationOptions<
		PutApiZonesByZoneIdNavigationByNavigationIdStatus200,
		ResponseErrorConfig<
			| PutApiZonesByZoneIdNavigationByNavigationIdStatus400
...
export function usePutApiZonesByZoneIdNavigationByNavigationId<TContext>(
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? putApiZonesByZoneIdNavigationByNavigationIdMutationKey();

	const baseOptions = putApiZonesByZoneIdNavigationByNavigationIdMutationOptions(
		config,
	) as UseMutationOptions<
		PutApiZonesByZoneIdNavigationByNavigationIdStatus200,
		ResponseErrorConfig<
...
export function deleteApiZonesByZoneIdNavigationByNavigationIdMutationOptions<TContext = unknown>(
	...
	const mutationKey = deleteApiZonesByZoneIdNavigationByNavigationIdMutationKey();
	return mutationOptions<
		DeleteApiZonesByZoneIdNavigationByNavigationIdStatus204,
		ResponseErrorConfig<
			| DeleteApiZonesByZoneIdNavigationByNavigationIdStatus403
...
export function useDeleteApiZonesByZoneIdNavigationByNavigationId<TContext>(
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? deleteApiZonesByZoneIdNavigationByNavigationIdMutationKey();

	const baseOptions = deleteApiZonesByZoneIdNavigationByNavigationIdMutationOptions(
		config,
	) as UseMutationOptions<
		DeleteApiZonesByZoneIdNavigationByNavigationIdStatus204,
		ResponseErrorConfig<
...
export function getApiUnitsByIdByUnitIdDocksQueryOptions(
	{ path }: GetApiUnitsByIdByUnitIdDocksOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiUnitsByIdByUnitIdDocksQueryKey({ path });
	return queryOptions<
		GetApiUnitsByIdByUnitIdDocksStatus200,
		ResponseErrorConfig<
			| GetApiUnitsByIdByUnitIdDocksStatus400
...
export function useGetApiUnitsByIdByUnitIdDocks<
	...
	TQueryData = GetApiUnitsByIdByUnitIdDocksStatus200,
	TQueryKey extends QueryKey = GetApiUnitsByIdByUnitIdDocksQueryKey,
>(
	{
		path,
	}: {
		path:
			| GetApiUnitsByIdByUnitIdDocksOptions["path"]
			| (() => GetApiUnitsByIdByUnitIdDocksOptions["path"]);
	},
	options: {
		query?: Partial<
	...
	const resolvedParams = { path: typeof path === "function" ? path() : path };
	const queryKey =
		resolvedOptions?.queryKey ?? getApiUnitsByIdByUnitIdDocksQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiUnitsByIdByUnitIdDocksQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export function getApiUnitsByIdByUnitIdDocksByKindQueryOptions(
	{ path }: GetApiUnitsByIdByUnitIdDocksByKindOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiUnitsByIdByUnitIdDocksByKindQueryKey({ path });
	return queryOptions<
		GetApiUnitsByIdByUnitIdDocksByKindStatus200,
		ResponseErrorConfig<
			| GetApiUnitsByIdByUnitIdDocksByKindStatus400
...
export function useGetApiUnitsByIdByUnitIdDocksByKind<
	...
	TQueryData = GetApiUnitsByIdByUnitIdDocksByKindStatus200,
	TQueryKey extends QueryKey = GetApiUnitsByIdByUnitIdDocksByKindQueryKey,
>(
	{
		path,
	}: {
		path:
			| GetApiUnitsByIdByUnitIdDocksByKindOptions["path"]
			| (() => GetApiUnitsByIdByUnitIdDocksByKindOptions["path"]);
	},
	options: {
		query?: Partial<
	...
	const resolvedParams = { path: typeof path === "function" ? path() : path };
	const queryKey =
		resolvedOptions?.queryKey ?? getApiUnitsByIdByUnitIdDocksByKindQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiUnitsByIdByUnitIdDocksByKindQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export function putApiUnitsByIdByUnitIdDocksByKindMutationOptions<TContext = unknown>(
	...
	const mutationKey = putApiUnitsByIdByUnitIdDocksByKindMutationKey();
	return mutationOptions<
		PutApiUnitsByIdByUnitIdDocksByKindStatus200,
		ResponseErrorConfig<
			| PutApiUnitsByIdByUnitIdDocksByKindStatus400
...
export function usePutApiUnitsByIdByUnitIdDocksByKind<TContext>(
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? putApiUnitsByIdByUnitIdDocksByKindMutationKey();

	const baseOptions = putApiUnitsByIdByUnitIdDocksByKindMutationOptions(
		config,
	) as UseMutationOptions<
		PutApiUnitsByIdByUnitIdDocksByKindStatus200,
		ResponseErrorConfig<
...
export function deleteApiUnitsByIdByUnitIdDocksByKindMutationOptions<TContext = unknown>(
	...
	const mutationKey = deleteApiUnitsByIdByUnitIdDocksByKindMutationKey();
	return mutationOptions<
		DeleteApiUnitsByIdByUnitIdDocksByKindStatus204,
		ResponseErrorConfig<
			| DeleteApiUnitsByIdByUnitIdDocksByKindStatus400
...
export function useDeleteApiUnitsByIdByUnitIdDocksByKind<TContext>(
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? deleteApiUnitsByIdByUnitIdDocksByKindMutationKey();

	const baseOptions = deleteApiUnitsByIdByUnitIdDocksByKindMutationOptions(
		config,
	) as UseMutationOptions<
		DeleteApiUnitsByIdByUnitIdDocksByKindStatus204,
		ResponseErrorConfig<
...
export const getApiUnitsByIdByUnitIdDocksByKindRevisionsQueryKey = ({
	path,
	query,
...
type GetApiUnitsByIdByUnitIdDocksByKindRevisionsQueryKey = ReturnType<
	typeof getApiUnitsByIdByUnitIdDocksByKindRevisionsQueryKey
>;

export function getApiUnitsByIdByUnitIdDocksByKindRevisionsQueryOptions(
	{ path, query }: GetApiUnitsByIdByUnitIdDocksByKindRevisionsOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiUnitsByIdByUnitIdDocksByKindRevisionsQueryKey({ path, query });
	return queryOptions<
		GetApiUnitsByIdByUnitIdDocksByKindRevisionsStatus200,
		ResponseErrorConfig<
			| GetApiUnitsByIdByUnitIdDocksByKindRevisionsStatus400
...
export function useGetApiUnitsByIdByUnitIdDocksByKindRevisions<
	...
	TQueryData = GetApiUnitsByIdByUnitIdDocksByKindRevisionsStatus200,
	TQueryKey extends QueryKey = GetApiUnitsByIdByUnitIdDocksByKindRevisionsQueryKey,
>(
	{
		path,
		query,
		...
		path:
			| GetApiUnitsByIdByUnitIdDocksByKindRevisionsOptions["path"]
			| (() => GetApiUnitsByIdByUnitIdDocksByKindRevisionsOptions["path"]);
		query?:
			| GetApiUnitsByIdByUnitIdDocksByKindRevisionsOptions["query"]
			| (() => GetApiUnitsByIdByUnitIdDocksByKindRevisionsOptions["query"]);
	},
	options: {
		query?: Partial<
	...
	const queryKey =
		resolvedOptions?.queryKey ??
		getApiUnitsByIdByUnitIdDocksByKindRevisionsQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiUnitsByIdByUnitIdDocksByKindRevisionsQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export function usePostApiUnitsByIdByUnitIdDocksByKindRevisionsByRevisionIdRestore<TContext>(
	...
	const baseOptions =
		postApiUnitsByIdByUnitIdDocksByKindRevisionsByRevisionIdRestoreMutationOptions(
			config,
		) as UseMutationOptions<
			PostApiUnitsByIdByUnitIdDocksByKindRevisionsByRevisionIdRestoreStatus200,
			ResponseErrorConfig<
...
export function resolveUnitSlugAddressMutationOptions<TContext = unknown>(
	...
	const mutationKey = resolveUnitSlugAddressMutationKey();
	return mutationOptions<
		ResolveUnitSlugAddressStatus200,
		ResponseErrorConfig<
			| ResolveUnitSlugAddressStatus400
...
export function useResolveUnitSlugAddress<TContext>(
	...
	const { mutation = {}, client: config = {} } = options ?? {};
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey = mutationOptions.mutationKey ?? resolveUnitSlugAddressMutationKey();

	const baseOptions = resolveUnitSlugAddressMutationOptions(config) as UseMutationOptions<
		ResolveUnitSlugAddressStatus200,
		ResponseErrorConfig<
			| ResolveUnitSlugAddressStatus400
			| ResolveUnitSlugAddressStatus404
...
export function useGetApiUnitsByIdByUnitIdSeriesMemberships<
	...
	TQueryData = GetApiUnitsByIdByUnitIdSeriesMembershipsStatus200,
	TQueryKey extends QueryKey = GetApiUnitsByIdByUnitIdSeriesMembershipsQueryKey,
>(
	{
		path,
	}: {
	...
	const queryResult = useQuery(
		{
			...getApiUnitsByIdByUnitIdSeriesMembershipsQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export const getApiUnitsByIdByUnitIdStatusEventsQueryKey = ({
	path,
	query,
...
type GetApiUnitsByIdByUnitIdStatusEventsQueryKey = ReturnType<
	typeof getApiUnitsByIdByUnitIdStatusEventsQueryKey
>;

export function getApiUnitsByIdByUnitIdStatusEventsQueryOptions(
	{ path, query }: GetApiUnitsByIdByUnitIdStatusEventsOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiUnitsByIdByUnitIdStatusEventsQueryKey({ path, query });
	return queryOptions<
		GetApiUnitsByIdByUnitIdStatusEventsStatus200,
		ResponseErrorConfig<
			| GetApiUnitsByIdByUnitIdStatusEventsStatus400
...
export function useGetApiUnitsByIdByUnitIdStatusEvents<
	...
	TQueryData = GetApiUnitsByIdByUnitIdStatusEventsStatus200,
	TQueryKey extends QueryKey = GetApiUnitsByIdByUnitIdStatusEventsQueryKey,
>(
	{
		path,
		query,
		...
		path:
			| GetApiUnitsByIdByUnitIdStatusEventsOptions["path"]
			| (() => GetApiUnitsByIdByUnitIdStatusEventsOptions["path"]);
		query?:
			| GetApiUnitsByIdByUnitIdStatusEventsOptions["query"]
			| (() => GetApiUnitsByIdByUnitIdStatusEventsOptions["query"]);
	},
	options: {
		query?: Partial<
	...
	const queryKey =
		resolvedOptions?.queryKey ?? getApiUnitsByIdByUnitIdStatusEventsQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiUnitsByIdByUnitIdStatusEventsQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export function patchApiUnitsByTypeByUnitIdVariantContextMutationOptions<TContext = unknown>(
	...
	const mutationKey = patchApiUnitsByTypeByUnitIdVariantContextMutationKey();
	return mutationOptions<
		PatchApiUnitsByTypeByUnitIdVariantContextStatus200,
		ResponseErrorConfig<
			| PatchApiUnitsByTypeByUnitIdVariantContextStatus401
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await patchApiUnitsByTypeByUnitIdVariantContext({
				...config,
				path,
				body,
				throwOnError: true,
...
export function usePatchApiUnitsByTypeByUnitIdVariantContext<TContext>(
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? patchApiUnitsByTypeByUnitIdVariantContextMutationKey();

	const baseOptions = patchApiUnitsByTypeByUnitIdVariantContextMutationOptions(
		config,
	) as UseMutationOptions<
		PatchApiUnitsByTypeByUnitIdVariantContextStatus200,
		ResponseErrorConfig<
...
export function postApiUnitsByTypeByUnitIdVariantContextPromoteMutationOptions<TContext = unknown>(
	...
	const mutationKey = postApiUnitsByTypeByUnitIdVariantContextPromoteMutationKey();
	return mutationOptions<
		PostApiUnitsByTypeByUnitIdVariantContextPromoteStatus200,
		ResponseErrorConfig<
			| PostApiUnitsByTypeByUnitIdVariantContextPromoteStatus401
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await postApiUnitsByTypeByUnitIdVariantContextPromote({
				...config,
				path,
				body,
				throwOnError: true,
...
export function usePostApiUnitsByTypeByUnitIdVariantContextPromote<TContext>(
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? postApiUnitsByTypeByUnitIdVariantContextPromoteMutationKey();

	const baseOptions = postApiUnitsByTypeByUnitIdVariantContextPromoteMutationOptions(
		config,
	) as UseMutationOptions<
		PostApiUnitsByTypeByUnitIdVariantContextPromoteStatus200,
		ResponseErrorConfig<
...
export const getApiEntitiesByUnitIdAssociationPolicyQueryKey = ({
	path,
}: Omit<GetApiEntitiesByUnitIdAssociationPolicyOptions, "headers">) =>
	[{ url: "/api/entities/:unitId/association-policy", params: path }] as const;

type GetApiEntitiesByUnitIdAssociationPolicyQueryKey = ReturnType<
	typeof getApiEntitiesByUnitIdAssociationPolicyQueryKey
>;

export function getApiEntitiesByUnitIdAssociationPolicyQueryOptions(
	{ path }: GetApiEntitiesByUnitIdAssociationPolicyOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiEntitiesByUnitIdAssociationPolicyQueryKey({ path });
	return queryOptions<
		GetApiEntitiesByUnitIdAssociationPolicyStatus200,
		ResponseErrorConfig<
			| GetApiEntitiesByUnitIdAssociationPolicyStatus404
	...
	>({
		queryKey,
		queryFn: async ({ signal }) => {
			const { data } = await getApiEntitiesByUnitIdAssociationPolicy({
				...config,
				path,
				signal: config.signal ?? signal,
				throwOnError: true,
 ...
 */
export function useGetApiEntitiesByUnitIdAssociationPolicy<
	TData = GetApiEntitiesByUnitIdAssociationPolicyStatus200,
	TQueryData = GetApiEntitiesByUnitIdAssociationPolicyStatus200,
	TQueryKey extends QueryKey = GetApiEntitiesByUnitIdAssociationPolicyQueryKey,
>(
	{
		path,
	}: {
		path:
			| GetApiEntitiesByUnitIdAssociationPolicyOptions["path"]
			| (() => GetApiEntitiesByUnitIdAssociationPolicyOptions["path"]);
	},
	options: {
		query?: Partial<
	...
	const queryKey =
		resolvedOptions?.queryKey ??
		getApiEntitiesByUnitIdAssociationPolicyQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiEntitiesByUnitIdAssociationPolicyQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export const patchApiEntitiesByUnitIdAssociationPolicyMutationKey = () =>
	[{ url: "/api/entities/:unitId/association-policy" }] as const;

export function patchApiEntitiesByUnitIdAssociationPolicyMutationOptions<TContext = unknown>(
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const mutationKey = patchApiEntitiesByUnitIdAssociationPolicyMutationKey();
	return mutationOptions<
		PatchApiEntitiesByUnitIdAssociationPolicyStatus200,
		ResponseErrorConfig<
			| PatchApiEntitiesByUnitIdAssociationPolicyStatus403
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await patchApiEntitiesByUnitIdAssociationPolicy({
				...config,
				path,
				body,
				throwOnError: true,
 ...
 * {@link /api/entities/:unitId/association-policy}
 */
export function usePatchApiEntitiesByUnitIdAssociationPolicy<TContext>(
	options: {
		mutation?: UseMutationOptions<
			PatchApiEntitiesByUnitIdAssociationPolicyStatus200,
			ResponseErrorConfig<
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? patchApiEntitiesByUnitIdAssociationPolicyMutationKey();

	const baseOptions = patchApiEntitiesByUnitIdAssociationPolicyMutationOptions(
		config,
	) as UseMutationOptions<
		PatchApiEntitiesByUnitIdAssociationPolicyStatus200,
		ResponseErrorConfig<
...
export function postApiUnitsByTypeByUnitIdCreditAttributionsMutationOptions<TContext = unknown>(
	...
	const mutationKey = postApiUnitsByTypeByUnitIdCreditAttributionsMutationKey();
	return mutationOptions<
		PostApiUnitsByTypeByUnitIdCreditAttributionsStatus200,
		ResponseErrorConfig<
			| PostApiUnitsByTypeByUnitIdCreditAttributionsStatus403
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await postApiUnitsByTypeByUnitIdCreditAttributions({
				...config,
				path,
				body,
				throwOnError: true,
...
export function usePostApiUnitsByTypeByUnitIdCreditAttributions<TContext>(
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? postApiUnitsByTypeByUnitIdCreditAttributionsMutationKey();

	const baseOptions = postApiUnitsByTypeByUnitIdCreditAttributionsMutationOptions(
		config,
	) as UseMutationOptions<
		PostApiUnitsByTypeByUnitIdCreditAttributionsStatus200,
		ResponseErrorConfig<
...
export function deleteApiUnitsByTypeByUnitIdCreditAttributionsByAssociationIdMutationOptions<
	TContext = unknown,
>(config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {}) {
	const mutationKey = deleteApiUnitsByTypeByUnitIdCreditAttributionsByAssociationIdMutationKey();
	return mutationOptions<
		DeleteApiUnitsByTypeByUnitIdCreditAttributionsByAssociationIdStatus204,
		ResponseErrorConfig<
			| DeleteApiUnitsByTypeByUnitIdCreditAttributionsByAssociationIdStatus403
...
export function deleteApiUnitsByTypeByUnitIdSubjectAssociationsByAssociationIdMutationOptions<
	TContext = unknown,
>(config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {}) {
	const mutationKey = deleteApiUnitsByTypeByUnitIdSubjectAssociationsByAssociationIdMutationKey();
	return mutationOptions<
		DeleteApiUnitsByTypeByUnitIdSubjectAssociationsByAssociationIdStatus204,
		ResponseErrorConfig<
			| DeleteApiUnitsByTypeByUnitIdSubjectAssociationsByAssociationIdStatus403
...
export const getApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsQueryKey = ({
	path,
	query,
...
type GetApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsQueryKey = ReturnType<
	typeof getApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsQueryKey
>;

export function getApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsQueryOptions(
	{ path, query }: GetApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsQueryKey({
		path,
		query,
	});
	return queryOptions<
...
>(
	{
		...
		path:
			| GetApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsOptions["path"]
			| (() => GetApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsOptions["path"]);
		query?:
			| GetApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsOptions["query"]
			| (() => GetApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsOptions["query"]);
	},
	options: {
		query?: Partial<
	...
	const queryKey =
		resolvedOptions?.queryKey ??
		getApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsQueryKey(resolvedParams);

	const queryResult = useQuery(
		{
			...getApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsQueryOptions(
				resolvedParams,
				config,
			),
			...resolvedOptions,
...
export const postApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsByRevisionIdRestoreMutationKey =
	() =>
		[
			{
...
export function postApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsByRevisionIdRestoreMutationOptions<
	TContext = unknown,
>(config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {}) {
	const mutationKey =
		postApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsByRevisionIdRestoreMutationKey();
	return mutationOptions<
		PostApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsByRevisionIdRestoreStatus200,
		ResponseErrorConfig<
			| PostApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsByRevisionIdRestoreStatus403
...
>(
	...
	const baseOptions =
		postApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsByRevisionIdRestoreMutationOptions(
			config,
		) as UseMutationOptions<
			PostApiUnitsByIdByUnitIdContentStructuresByStructureIdRevisionsByRevisionIdRestoreStatus200,
			ResponseErrorConfig<
...
export function postApiCollectionsByCollectionIdItemsBatchMutationOptions<TContext = unknown>(
	...
	const mutationKey = postApiCollectionsByCollectionIdItemsBatchMutationKey();
	return mutationOptions<
		PostApiCollectionsByCollectionIdItemsBatchStatus200,
		ResponseErrorConfig<
			| PostApiCollectionsByCollectionIdItemsBatchStatus403
...
export function usePostApiCollectionsByCollectionIdItemsBatch<TContext>(
	...
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey =
		mutationOptions.mutationKey ?? postApiCollectionsByCollectionIdItemsBatchMutationKey();

	const baseOptions = postApiCollectionsByCollectionIdItemsBatchMutationOptions(
		config,
	) as UseMutationOptions<
		PostApiCollectionsByCollectionIdItemsBatchStatus200,
		ResponseErrorConfig<
...
export const getApiRealmsByRealmIdUnitsQueryKey = ({
	path,
	query,
...
export function getApiRealmsByRealmIdUnitsQueryOptions(
	{ path, query }: GetApiRealmsByRealmIdUnitsOptions,
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiRealmsByRealmIdUnitsQueryKey({ path, query });
	return queryOptions<
		GetApiRealmsByRealmIdUnitsStatus200,
		ResponseErrorConfig<
			| GetApiRealmsByRealmIdUnitsStatus403
...
export function useGetApiRealmsByRealmIdUnits<
	...
	TQueryData = GetApiRealmsByRealmIdUnitsStatus200,
	TQueryKey extends QueryKey = GetApiRealmsByRealmIdUnitsQueryKey,
>(
	{
		path,
		query,
		...
		path:
			| GetApiRealmsByRealmIdUnitsOptions["path"]
			| (() => GetApiRealmsByRealmIdUnitsOptions["path"]);
		query?:
			| GetApiRealmsByRealmIdUnitsOptions["query"]
			| (() => GetApiRealmsByRealmIdUnitsOptions["query"]);
	},
	options: {
		query?: Partial<
	...
	const queryResult = useQuery(
		{
			...getApiRealmsByRealmIdUnitsQueryOptions(resolvedParams, config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
...
export const getApiSearchConfigurationQueryKey = () =>
	[{ url: "/api/search/configuration" }] as const;

type GetApiSearchConfigurationQueryKey = ReturnType<typeof getApiSearchConfigurationQueryKey>;

export function getApiSearchConfigurationQueryOptions(
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const queryKey = getApiSearchConfigurationQueryKey();
	return queryOptions<
		GetApiSearchConfigurationStatus200,
		ResponseErrorConfig<GetApiSearchConfigurationStatus500>,
		GetApiSearchConfigurationStatus200,
		typeof queryKey
	>({
		queryKey,
		queryFn: async ({ signal }) => {
			const { data } = await getApiSearchConfiguration({
				...config,
				signal: config.signal ?? signal,
				throwOnError: true,
			});
 ...
 */
export function useGetApiSearchConfiguration<
	TData = GetApiSearchConfigurationStatus200,
	TQueryData = GetApiSearchConfigurationStatus200,
	TQueryKey extends QueryKey = GetApiSearchConfigurationQueryKey,
>(
	options: {
		query?: Partial<
			QueryObserverOptions<
	...
	const { query: queryConfig = {}, client: config = {} } = options ?? {};
	const { client: queryClient, ...resolvedOptions } = queryConfig;
	const queryKey = resolvedOptions?.queryKey ?? getApiSearchConfigurationQueryKey();

	const queryResult = useQuery(
		{
			...getApiSearchConfigurationQueryOptions(config),
			...resolvedOptions,
			queryKey,
		} as unknown as QueryObserverOptions,
		queryClient,
	) as UseQueryResult<TData, ResponseErrorConfig<GetApiSearchConfigurationStatus500>> & {
		queryKey: TQueryKey;
	};
...
export const postApiSearchExecuteMutationKey = () => [{ url: "/api/search/execute" }] as const;

export function postApiSearchExecuteMutationOptions<TContext = unknown>(
	config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {},
) {
	const mutationKey = postApiSearchExecuteMutationKey();
	return mutationOptions<
		PostApiSearchExecuteStatus200,
		ResponseErrorConfig<
			| PostApiSearchExecuteStatus422
	...
	>({
		mutationKey,
		mutationFn: async ({ body }) => {
			const { data } = await postApiSearchExecute({ ...config, body, throwOnError: true });
			return data;
		},
	});
}
 ...
 */
export function usePostApiSearchExecute<TContext>(
	options: {
		mutation?: UseMutationOptions<
			PostApiSearchExecuteStatus200,
			ResponseErrorConfig<
	...
	const { mutation = {}, client: config = {} } = options ?? {};
	const { client: queryClient, ...mutationOptions } = mutation;
	const mutationKey = mutationOptions.mutationKey ?? postApiSearchExecuteMutationKey();

	const baseOptions = postApiSearchExecuteMutationOptions(config) as UseMutationOptions<
		PostApiSearchExecuteStatus200,
		ResponseErrorConfig<
			| PostApiSearchExecuteStatus422
			| PostApiSearchExecuteStatus500
...
export const postApiSearchUnitsByUnitIdContentStructuresByStructureIdNodesByNodeIdExecuteMutationKey =
	() =>
		[
			{
...
export function postApiSearchUnitsByUnitIdContentStructuresByStructureIdNodesByNodeIdExecuteMutationOptions<
	TContext = unknown,
>(config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {}) {
	const mutationKey =
		postApiSearchUnitsByUnitIdContentStructuresByStructureIdNodesByNodeIdExecuteMutationKey();
	return mutationOptions<
		PostApiSearchUnitsByUnitIdContentStructuresByStructureIdNodesByNodeIdExecuteStatus200,
		ResponseErrorConfig<
			| PostApiSearchUnitsByUnitIdContentStructuresByStructureIdNodesByNodeIdExecuteStatus404
	...
	>({
		...
		mutationFn: async ({ path, body }) => {
			const { data } =
				await postApiSearchUnitsByUnitIdContentStructuresByStructureIdNodesByNodeIdExecute({
					...config,
					path,
					body,
					throwOnError: true,
 ...
 */
export function usePostApiSearchUnitsByUnitIdContentStructuresByStructureIdNodesByNodeIdExecute<
	TContext,
>(
	options: {
		mutation?: UseMutationOptions<
	...
	const baseOptions =
		postApiSearchUnitsByUnitIdContentStructuresByStructureIdNodesByNodeIdExecuteMutationOptions(
			config,
		) as UseMutationOptions<
			PostApiSearchUnitsByUnitIdContentStructuresByStructureIdNodesByNodeIdExecuteStatus200,
			ResponseErrorConfig<
...
export function postApiSearchZonesByZoneIdDockBlocksByBlockKeyExecuteMutationOptions<
	TContext = unknown,
>(config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {}) {
	const mutationKey = postApiSearchZonesByZoneIdDockBlocksByBlockKeyExecuteMutationKey();
	return mutationOptions<
		PostApiSearchZonesByZoneIdDockBlocksByBlockKeyExecuteStatus200,
		ResponseErrorConfig<
			| PostApiSearchZonesByZoneIdDockBlocksByBlockKeyExecuteStatus404
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await postApiSearchZonesByZoneIdDockBlocksByBlockKeyExecute({
				...config,
				path,
				body,
				throwOnError: true,
...
export function usePostApiSearchZonesByZoneIdDockBlocksByBlockKeyExecute<TContext>(
	...
	const mutationKey =
		mutationOptions.mutationKey ??
		postApiSearchZonesByZoneIdDockBlocksByBlockKeyExecuteMutationKey();

	const baseOptions = postApiSearchZonesByZoneIdDockBlocksByBlockKeyExecuteMutationOptions(
		config,
	) as UseMutationOptions<
		PostApiSearchZonesByZoneIdDockBlocksByBlockKeyExecuteStatus200,
		ResponseErrorConfig<
...
export const postApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecuteMutationKey = () =>
	[{ url: "/api/search/zones/:zoneId/pages/:slug/blocks/:blockKey/execute" }] as const;

export function postApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecuteMutationOptions<
	TContext = unknown,
>(config: Partial<Omit<RequestConfig, "path" | "query" | "body" | "headers" | "url">> = {}) {
	const mutationKey = postApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecuteMutationKey();
	return mutationOptions<
		PostApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecuteStatus200,
		ResponseErrorConfig<
			| PostApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecuteStatus404
	...
	>({
		mutationKey,
		mutationFn: async ({ path, body }) => {
			const { data } = await postApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecute({
				...config,
				path,
				body,
				throwOnError: true,
 ...
 */
export function usePostApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecute<TContext>(
	options: {
		mutation?: UseMutationOptions<
			PostApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecuteStatus200,
			ResponseErrorConfig<
	...
	const mutationKey =
		mutationOptions.mutationKey ??
		postApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecuteMutationKey();

	const baseOptions = postApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecuteMutationOptions(
		config,
	) as UseMutationOptions<
		PostApiSearchZonesByZoneIdPagesBySlugBlocksByBlockKeyExecuteStatus200,
		ResponseErrorConfig<
