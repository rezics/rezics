...
export const CalendarControl = (props: React.ComponentProps<typeof ArkCalendar.Control>) => (
	<ArkCalendar.Control
...
export const CalendarLabel = (props: React.ComponentProps<typeof ArkCalendar.Label>) => (
	<ArkCalendar.Label className="font-medium text-sm" data-slot="calendar-label" {...props} />
);

export const CalendarTrigger = (props: React.ComponentProps<typeof ArkCalendar.Trigger>) => (
...
export const CalendarViewDate = (props: React.ComponentProps<typeof ArkCalendar.RangeText>) => {
...
export const CalendarYearSelect = (props: React.ComponentProps<typeof ArkCalendar.YearSelect>) => {
	const { className, ...rest } = props;
...
export const CalendarView = (props: React.ComponentProps<typeof ArkCalendar.View>) => {
	const { className, ...rest } = props;
...
export const CalendarContext = (props: React.ComponentProps<typeof ArkCalendar.Context>) => (
...
export const CalendarTable = (props: React.ComponentProps<typeof ArkCalendar.Table>) => {
	const { className, ...rest } = props;
...
interface CalendarWeekDaysProps extends React.ComponentProps<typeof ArkCalendar.TableHead> {
	/**
...
export const CalendarTableDays = (props: React.ComponentProps<typeof CalendarTableBody>) => {
...
interface CalendarTableNextMonthProps extends React.ComponentProps<typeof CalendarTableBody> {
	/**
...
export const CalendarTableHead = (props: React.ComponentProps<typeof ArkCalendar.TableHead>) => (
	<ArkCalendar.TableHead data-slot="calendar-table-head" {...props} />
);

export const CalendarTableRow = (props: React.ComponentProps<typeof ArkCalendar.TableRow>) => {
	const { className, ...rest } = props;
	return (
...
export const CalendarTableBody = (props: React.ComponentProps<typeof ArkCalendar.TableBody>) => (
	<ArkCalendar.TableBody data-slot="calendar-table-body" {...props} />
);

export const CalendarTableCell = (props: React.ComponentProps<typeof ArkCalendar.TableCell>) => {
