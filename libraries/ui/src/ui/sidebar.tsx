...
export const Sidebar = (props: SidebarProps) => {
	...
	if (isMobile) {
		return (
			<Sheet {...props} onOpenChange={({ open }) => setOpenMobile(open)} open={openMobile}>
				<SheetContent
					className={cn(
						"w-(--sidebar-width)",
						"p-0",
...
export const SidebarGroupLabel = (props: React.ComponentProps<typeof ark.div>) => {
	const { className, ...rest } = props;
...
export const SidebarGroupAction = (props: React.ComponentProps<typeof ark.button>) => {
	const { className, ...rest } = props;
...
export const SidebarGroupContent = (props: React.ComponentProps<typeof ark.div>) => {
	const { className, ...rest } = props;
...
export const SidebarMenuButton = ({ tooltip, ...props }: SidebarMenuButtonProps) => {
	const { isActive = false, size = "md", variant = "ghost", className, ...rest } = props;
...
interface SidebarMenuActionProps extends React.ComponentProps<typeof ark.button> {
	showOnHover?: boolean;
}
...
export const SidebarMenuBadge = (props: React.ComponentProps<typeof ark.div>) => {
	const { className, ...rest } = props;
...
interface SidebarMenuSkeletonProps extends React.ComponentProps<typeof ark.div> {
	showIcon?: boolean;
}
