...
export const BreadcrumbPage = (props: React.ComponentProps<typeof ark.span>) => {
	const { className, ...rest } = props;
...
export const BreadcrumbSeparator = (props: React.ComponentProps<typeof ark.li>) => {
...
export const BreadcrumbEllipsis = (props: React.ComponentProps<typeof ark.span>) => (
	<ark.span aria-hidden="true" data-slot="breadcrumb-ellipsis" role="presentation" {...props}>
