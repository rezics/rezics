		...
		<ArkDatePicker.Control data-slot="date-picker-control">
			<InputGroup size={size}>
				...
				<InputGroupAddon align="inline-end">
					<InputGroupButton asChild data-slot="input-group-button" size="icon-xs" variant="ghost">
...
export const DatePickerContent = (props: React.ComponentProps<typeof ArkDatePicker.Content>) => {
...
export const DatePickerValue = (props: React.ComponentProps<typeof ArkDatePicker.ValueText>) => {
	const { className, ...rest } = props;
