...
const TourProvider = React.createContext<TourProviderProps>({} as TourProviderProps);

interface TourProps extends Omit<React.ComponentProps<typeof ArkTour.Root>, "tour"> {
	/**
...
export const TourActionTrigger = (props: React.ComponentProps<typeof ArkTour.ActionTrigger>) => (
	<ArkTour.ActionTrigger data-slot="tour-action-trigger" {...props} />
);

export const TourOverlay = (props: React.ComponentProps<typeof DialogOverlay>) => {
...
export const TourPositioner = (props: React.ComponentProps<typeof ArkTour.Positioner>) => (
	<ArkTour.Positioner
		className={cn(
			"z-50",
...
interface TourContentProps extends React.ComponentProps<typeof ArkTour.Content> {
	/**
...
export const TourSpotlight = (props: React.ComponentProps<typeof ArkTour.Spotlight>) => (
	<ArkTour.Spotlight
...
export const TourHeader = (props: React.ComponentProps<typeof DialogHeader>) => (
	<DialogHeader data-slot="tour-header" {...props} />
);

export const TourTitle = (props: React.ComponentProps<typeof ArkTour.Title>) => {
	const { className, ...rest } = props;
...
export const TourDescription = (props: React.ComponentProps<typeof ArkTour.Description>) => {
	const { className, ...rest } = props;
...
export const TourProgressText = (props: React.ComponentProps<typeof ArkTour.ProgressText>) => {
	const { className, ...rest } = props;
...
export const TourClose = (props: React.ComponentProps<typeof ArkTour.CloseTrigger>) => (
	<ArkTour.CloseTrigger data-slot="tour-close-trigger" {...props} />
);

export const TourFooter = (props: React.ComponentProps<typeof DialogFooter>) => {
...
export const TourActions = (props: React.ComponentProps<typeof DialogFooter>) => {
	const { className, ...rest } = props;
