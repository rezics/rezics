...
export const DrawerTrigger = (props: React.ComponentProps<typeof ArkDrawer.Trigger>) => (
...
export const DrawerOverlay = (props: React.ComponentProps<typeof ArkDrawer.Backdrop>) => {
		...
		<Portal>
			...
			<DrawerContext>
				{({ snapPoints, swipeDirection }) => {
					...
					const fullHeight = isVertical && needsFullHeightForSnapPoints(snapPoints);
...
interface DrawerGrabberProps extends React.ComponentProps<typeof ArkDrawer.Grabber> {
	/**
...
export const DrawerTitle = (props: React.ComponentProps<typeof ArkDrawer.Title>) => {
	const { className, ...rest } = props;
	return (
		<ArkDrawer.Title
			className={cn("text-center font-semibold text-lg leading-none", className)}
...
export const DrawerDescription = (props: React.ComponentProps<typeof ArkDrawer.Description>) => {
	const { className, ...rest } = props;
	return (
