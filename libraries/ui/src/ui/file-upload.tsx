...
export const FileUpload = (props: React.ComponentProps<typeof ArkFileUpload.Root>) => {
...
export const FileUploadTrigger = (props: React.ComponentProps<typeof ArkFileUpload.Trigger>) => (
	<ArkFileUpload.Trigger data-slot="file-upload-trigger" {...props} />
);

export const FileUploadDropzone = (props: React.ComponentProps<typeof ArkFileUpload.Dropzone>) => {
...
export const FileUploadDropzoneIcon = (props: React.ComponentProps<typeof ark.div>) => {
	const { className, children, ...rest } = props;
...
export const FileUploadTitle = (props: React.ComponentProps<typeof ark.div>) => {
	const { className, ...rest } = props;
...
export const FileUploadDescription = (props: React.ComponentProps<typeof ark.div>) => {
	const { className, ...rest } = props;
...
export const FileUploadHelper = (props: React.ComponentProps<typeof ark.div>) => {
	const { className, ...rest } = props;
...
export const FileUploadItem = (props: React.ComponentProps<typeof ArkFileUpload.Item>) => {
	const { className, ...rest } = props;
...
export const FileUploadItemPreviewImage = (
	...
	return (
		<ArkFileUpload.ItemPreviewImage
			className={cn("aspect-square size-full", "object-cover", "rounded-lg", className)}
...
export const FileUploadItemName = (props: React.ComponentProps<typeof ArkFileUpload.ItemName>) => {
	const { className, ...rest } = props;

	return (
		<ArkFileUpload.ItemName
			className={cn("truncate font-medium text-xs", "min-w-0", "overflow-hidden", className)}
...
) => <ArkFileUpload.ItemDeleteTrigger data-slot="file-upload-item-delete-trigger" {...props} />;

export const FileUploadClearTrigger = (
	props: React.ComponentProps<typeof ArkFileUpload.ClearTrigger>,
) => <ArkFileUpload.ClearTrigger data-slot="file-upload-clear-trigger" {...props} />;

export const FileUploadRootProvider = (
	props: React.ComponentProps<typeof ArkFileUpload.RootProvider>,
) => <ArkFileUpload.RootProvider data-slot="file-upload-root-provider" {...props} />;
