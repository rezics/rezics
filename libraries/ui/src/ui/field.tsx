...
export const FieldSet = (props: React.ComponentProps<typeof ArkFieldset.Root>) => {
...
interface FieldLegendProps extends React.ComponentProps<typeof ArkFieldset.Legend> {
	/**
...
export const FieldLabel = (props: React.ComponentProps<typeof ArkField.Label>) => {
	const { className, ...rest } = props;
...
export const FieldRequiredIndicator = (props: React.ComponentProps<typeof ark.span>) => {
...
export const FieldHelper = (props: React.ComponentProps<typeof ArkField.HelperText>) => {
	const { className, ...rest } = props;
...
export const FieldError = (props: React.ComponentProps<typeof ArkField.ErrorText>) => {
	const { className, ...rest } = props;
