...
export const TooltipTrigger = (props: React.ComponentProps<typeof ArkTooltip.Trigger>) => (
	<ArkTooltip.Trigger data-slot="tooltip-trigger" {...props} />
);

export const TooltipContent = (props: React.ComponentProps<typeof ArkTooltip.Content>) => {
...
export const TooltipArrow = (props: React.ComponentProps<typeof ArkTooltip.Arrow>) => {
