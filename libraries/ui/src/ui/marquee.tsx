...
interface MarqueeProps extends Omit<React.ComponentProps<typeof ArkMarquee.Root>, "side"> {
	/**
	 *
	 * @default "horizontal"
	 */
...
export const Marquee = (props: MarqueeProps) => {
	...
	return (
		<ArkMarquee.Root
			className={cn("group/marquee", "relative", "w-full max-w-full", "isolate", className)}
...
export const MarqueeContent = (props: React.ComponentProps<typeof ArkMarquee.Content>) => {
	const { className, ...rest } = props;

	return (
		<ArkMarquee.Viewport className="flex overflow-hidden" data-slot="marquee-viewport">
			<ArkMarquee.Content
				className={cn(
					"flex",
					"min-w-max",
...
export const MarqueeItem = (props: React.ComponentProps<typeof ArkMarquee.Item>) => {
	const { className, ...rest } = props;
...
export const MarqueeEdge = (props: React.ComponentProps<typeof ArkMarquee.Edge>) => {
	const { className, ...rest } = props;
