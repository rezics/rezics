...
import { AngleSlider as ArkAngleSlider, useAngleSliderContext } from "@ark-ui/react/angle-slider";
...
export const CircularSliderThumb = (props: React.ComponentProps<typeof ArkAngleSlider.Thumb>) => {
...
export const CircularSliderMarkerGroup = (
	...
	return (
		<ArkAngleSlider.MarkerGroup
			className={cn("absolute inset-0 z-0", "rounded-full", "pointer-events-none", className)}
...
export const CircularSliderMarker = (props: React.ComponentProps<typeof ArkAngleSlider.Marker>) => {
...
const ClockMarkerAngles = [0, 60, 120, 180, 240, 300];
