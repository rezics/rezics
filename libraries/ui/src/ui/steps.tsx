...
export const StepsList = (props: React.ComponentProps<typeof ArkSteps.List>) => {
	const { className, ...rest } = props;
...
export const StepsItem = (props: React.ComponentProps<typeof ArkSteps.Item>) => {
	const { className, ...rest } = props;
...
interface StepsTriggerProps extends React.ComponentProps<typeof ArkSteps.Trigger> {}
...
export const StepsIndicator = (props: React.ComponentProps<typeof ArkSteps.Indicator>) => {
...
export const StepsSeparator = (props: React.ComponentProps<typeof ArkSteps.Separator>) => {
	const { className, ...rest } = props;
...
export const StepsDescription = (props: React.ComponentProps<typeof ark.span>) => {
	const { className, ...rest } = props;
...
export const StepsContent = (props: React.ComponentProps<typeof ArkSteps.Content>) => {
	const { className, ...rest } = props;
...
export const StepsPrevious = (props: React.ComponentProps<typeof ArkSteps.PrevTrigger>) => (
	<ArkSteps.PrevTrigger data-slot="steps-previous" {...props} />
);

export const StepsNext = (props: React.ComponentProps<typeof ArkSteps.NextTrigger>) => (
