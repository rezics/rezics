...
export const TreeViewLabel = (props: React.ComponentProps<typeof ArkTreeView.Label>) => {
...
export const TreeViewTree = (props: React.ComponentProps<typeof ArkTreeView.Tree>) => {
	const { className, ...rest } = props;
...
interface TreeViewBranchTitleProps extends React.ComponentProps<typeof ArkTreeView.BranchText> {
	/**
...
const TreeViewBranchTitle = (props: TreeViewBranchTitleProps) => {
	const { icon: Icon, expandedIcon: ExpandedIcon, className, children, ...rest } = props;
...
interface TreeViewItemProps extends React.ComponentProps<typeof TreeViewItemTitle> {
	/**
	 * Custom file icon
	 *
	 * @default <FileIcon />
...
const TreeViewItemTitle = (props: React.ComponentProps<typeof ArkTreeView.ItemText>) => {
	const { className, ...rest } = props;
...
export const TreeViewCheckbox = (props: React.ComponentProps<typeof ArkTreeView.NodeCheckbox>) => {
	const { className, ...rest } = props;
...
const TreeViewNodeInput = (props: React.ComponentProps<typeof ArkTreeView.NodeRenameInput>) => {
	const { className, ...rest } = props;
