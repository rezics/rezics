...
export interface ActionBarTriggerProps extends React.ComponentProps<typeof ark.button> {}
...
export interface ActionBarContentProps extends React.ComponentProps<typeof ark.div> {}
...
export interface ActionBarSeparatorProps extends React.ComponentProps<typeof Separator> {}
...
export interface ActionBarCloseProps extends React.ComponentProps<typeof ark.button> {}
...
export interface ActionBarValueProps extends React.ComponentProps<typeof Badge> {
	/**
