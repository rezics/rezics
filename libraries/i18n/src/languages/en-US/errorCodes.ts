export default {
	...
	ApiTokenScopeRequired: "This API token does not have the required permission.",
	...
	UnitEditForbidden: "You do not have permission to edit this content.",
	UnitRestoreForbidden: "You do not have permission to restore this content.",
	UnitFieldLocked: "This field is locked and cannot be changed.",
	...
	UnitCoverKeyForbidden: "This cover file does not belong to your account.",
	UnitCoverIncomplete: "The cover file has not finished uploading.",
	UnitCoverUnsupported: "This cover image type is not supported.",
	UnitCoverContentMismatch: "The cover content does not match its declared type.",
	UnitOriginalLanguageMissing: "The original language needs an existing localization.",
	UploadUnsupportedType: "This file type is not supported.",
	UploadKeyForbidden: "This file does not belong to your account.",
	UploadNotFound: "The uploaded file could not be found.",
	UploadInvalidSize: "The uploaded file size is invalid.",
	UploadContentMismatch: "The uploaded content does not match its declared type.",
	ApiTokenReadScopeRequired: "API tokens must include read access.",
	ApiTokenExpiryInvalid: "The API token expiry must be in the future.",
	...
	GameSystemRequirementSourceInvalid: "The system-requirement source must belong to this game.",
	SeriesReleaseNotFound: "This series release could not be found.",
	SeriesReleaseRangeInvalid: "The end time must be later than the start time.",
	ZonePageNotFound: "This zone page could not be found.",
	GameNotFound: "This game could not be found.",
	...
	ContentNodeNotFound: "This content node could not be found.",
	...
	ModerationTargetPathRequired: "A target field is required for this action.",
	...
	CollaboratorNotFound: "This collaborator could not be found.",
	UnitOwnerRequired: "A Unit must keep at least one owner.",
	FieldLockNotFound: "This field lock could not be found.",
	...
	RealmContentNotFound: "This Realm content could not be found.",
