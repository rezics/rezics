...
export default {
	...
	references: {
		...
		linksTitle: "Liens sources",
		linksDescription: "Des pages publiques qui étayent les informations sur cette œuvre.",
		aliasTerm: "Alias",
		aliasPlaceholder: "Saisir un autre nom",
		proposeAlias: "Proposer l’alias",
		proposeLink: "Proposer la source",
		sourceEntity: `${entityTerms.label} source`,
		sourcePlaceholder: `Choisir une ${entityTerms.inline} source`,
		sourceUrl: `${verbatimTerms.url.value} de la source`,
		urlPlaceholder: `${verbatimTerms.https.value}://`,
		accepted: "Acceptée",
		...
		linkProposed: "Lien source proposé",
		noAliases: "Aucune proposition d’alias pour le moment.",
		noLinks: "Aucune proposition de lien source pour le moment.",
	},
	contentLanguages: {
