...
export default {
	...
	search: "Rechercher",
	shelf: {
		label: "Carrousel de contenus",
		previous: "Éléments précédents",
		next: "Éléments suivants",
		page: insert("Page {{page}} sur {{pageCount}}", { page: Number, pageCount: Number }),
		item: insert("Élément {{item}} sur {{itemCount}}", { item: Number, itemCount: Number }),
	},
	pickerPlaceholders: {
	...
	chapterTitle: `Titre du ${frTerminology.chapter.forms.inline}`,
	chapterContent: `Contenu du ${frTerminology.chapter.forms.inline}`,
	position: "Position",
	publishChapter: `Publier le ${frTerminology.chapter.forms.inline}`,
