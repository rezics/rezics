...
export default {
	...
	participation: {
		...
		sourceChange: "Modification de source",
		history: "Historique",
		restore: "Restaurer",
		title: "Organisations et accès",
		description: "Créez des organisations et gérez leurs identités publiques et leurs autorisations déléguées.",
		organizations: "Organisations",
		createOrganization: "Créer une organisation",
		name: "Nom",
		manage: "Gérer les accès",
		identity: "Identité utilisée",
		grantAccess: "Accorder un accès",
		recipient: "Identité publique du compte",
		permission: "Autorisation",
		expiresAt: "Expire le",
		revoke: "Révoquer",
		revoked: "Révoquée",
		grants: "Autorisations",
		noGrants: "Aucune autorisation.",
		services: "Identités d’automatisation",
		createService: "Créer une identité d’automatisation",
		credential: "Identifiant secret",
		credentialDescription: "Copiez cet identifiant secret maintenant. Il ne sera plus affiché après la fermeture.",
		securityWarning: "La révocation du dernier responsable humain de la sécurité suspend cette identité jusqu’à sa récupération vérifiée par la plateforme.",
		revokeWarning: "Cette autorisation cessera de fonctionner immédiatement. Les actions terminées resteront enregistrées.",
		erasedRecipient: "Compte supprimé",
		currentAccount: "Mon identité",
		eraseTitle: "Supprimer le compte",
		eraseDescription: "La connexion sera immédiatement désactivée. Les notes privées, favoris, progrès, messages et fichiers envoyés seront supprimés par lots. Les attributions publiques et les journaux d’audit seront conservés. Cette action est irréversible.",
		eraseConfirmation: "Je comprends que mon compte et mes données privées ne pourront pas être récupérés.",
		erase: "Supprimer mon compte",
		erased: "La suppression du compte a commencé.",
		capabilities: {
			"catalog.read": "Lire les enregistrements",
			"catalog.edit": "Modifier les enregistrements",
			"entity.publish": "Publier sous cette identité",
			"entity.membership": "Gérer les membres",
			"entity.security": "Gérer la sécurité",
			"proposal.adopt": "Approuver une modification de source",
		},
	},
	workspace: {
		title: "Réglages",
