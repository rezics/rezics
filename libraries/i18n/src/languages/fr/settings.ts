...
export default {
	...
	tokens: {
		...
		permissionLabels: {
			...
			unitDelete: "Supprimer des Units",
		...
		limitRanges: insert(
			"Plages autorisées : {{requestsMinimum}} à {{requestsMaximum}} requêtes par minute ; {{concurrentMinimum}} à {{concurrentMaximum}} requêtes simultanées ; {{dailyMinimum}} à {{dailyMaximum}} unités de coût quotidiennes.",
			{
	...
	defaultScoreContext: "Contexte de notation par défaut",
	defaultScoreContextHint: `Les notes des pages générales utilisent ce contexte. Les notes créées dans un autre ${realmTerms.inline} conservent ce contexte local.`,
	general: "Général",
