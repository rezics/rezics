...
export default {
	...
	publisherAttributions: `Crédits d’${frTerminology.publisher.forms.inline}`,
	publisherAttributionDescription: `Ajoutez directement un ${frTerminology.publisher.forms.inline} si son profil l’autorise ; sinon, envoyez ci-dessous une demande d’association.`,
	publisherProfile: `Profil de l’${frTerminology.publisher.forms.inline}`,
	addPublisher: `Ajouter l’${frTerminology.publisher.forms.inline}`,
	removePublisher: `Retirer l’${frTerminology.publisher.forms.inline}`,
	noPublishers: `Aucun ${frTerminology.publisher.forms.inline} n’est crédité.`,
	...
	capabilities: {
		"catalog.definition.manage": "Gérer les définitions et règles de validation du catalogue",
