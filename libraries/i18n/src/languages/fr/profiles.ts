...
export default {
	...
	contentDescription: `Les ${postTerms.plural} publiques et les avis attribués à cette personne, ainsi que les collections et ${entityTerms.plural} dont elle est propriétaire.`,
