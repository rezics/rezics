...
export default {
	privateFavorites: {
		...
		save: "Enregistrer en privé",
		empty: "Aucun élément enregistré.",
		refreshPreview: "Actualiser l’aperçu enregistré",
		moveFirst: "Déplacer au début",
		history: "Historique",
		restore: "Restaurer",
		privacy: "Vous seul pouvez voir ces éléments enregistrés et ces notes.",
	},
	title: "Collections",
	favorites: "Favoris",
