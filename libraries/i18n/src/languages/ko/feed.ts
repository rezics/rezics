...
export default {
	...
	content: {
		...
		kinds: {
			"publishing:work": koTerminology.publishingWork.forms.pluralLabel,
			"publishing:text_version": koTerminology.textVersion.forms.pluralLabel,
			"publishing:publication": koTerminology.publication.forms.pluralLabel,
			...
			"program:program": koTerminology.program.forms.pluralLabel,
			"software:content": koTerminology.softwareContent.forms.pluralLabel,
			"software:version": koTerminology.softwareVersion.forms.pluralLabel,
			"software:release": koTerminology.softwareRelease.forms.pluralLabel,
			"grouping:grouping": koTerminology.grouping.forms.pluralLabel,
			"entity:person": koTerminology.entity.forms.personLabel,
			"entity:organization": koTerminology.entity.forms.organizationLabel,
			"entity:character": koTerminology.entity.forms.characterLabel,
			"reference:concept": koTerminology.referenceConcept.forms.pluralLabel,
			"distribution:package": koTerminology.distributionPackage.forms.pluralLabel,
			"video:video": koTerminology.video.forms.pluralLabel,
			"audio:audio": koTerminology.audio.forms.pluralLabel,
			"zone:zone": koTerminology.zone.forms.pluralLabel,
			"realm:realm": koTerminology.realm.forms.pluralLabel,
			"post:post": koTerminology.post.forms.pluralLabel,
			"post:chapter": koTerminology.chapter.forms.pluralLabel,
			"tag:tag": "태그",
		...
		owners: {
			...
			audio: koTerminology.audio.forms.label,
			video: koTerminology.video.forms.label,
			post: koTerminology.post.forms.label,
			zone: koTerminology.zone.forms.label,
			realm: koTerminology.realm.forms.label,
			custom_theme: koTerminology.customTheme.forms.label,
			label: koTerminology.label.forms.label,
			tag_path: koTerminology.tagPath.forms.label,
			tag: "태그",
			collection: "컬렉션",
			poll: "설문조사",
			realm_rule: `${koTerminology.realm.forms.label} 규칙`,
		},
