...
export default {
	...
	presentationEditor: {
		...
		description: {
			avatar:
				"사각형 자르기 범위 안에서 이미지를 드래그하고 확대/축소하세요. 원형 아바타 미리보기는 원래 모서리를 제거하지 않습니다.",
			banner:
				"고정 4:1 자르기 범위 안에서 이미지를 드래그하고 확대/축소하세요. 새 배너는 좌상단에서 시작합니다.",
			cover:
				"기본적으로 전체 이미지를 유지하거나, 구성이 더 중요할 때 고정 3:4 크롭으로 전환하세요.",
		},
		close: "이미지 조정 닫기",
		loading: "원본 이미지 로딩 중…",
