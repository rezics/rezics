...
export default {
	...
	sections: {
		...
		tokenPolicies: {
			label: `${verbatimTerms.api.value} 토큰 정책`,
			description: `${verbatimTerms.api.value} 토큰의 전역 속도, 동시 요청 및 비용 한도를 관리합니다.`,
		},
	},
	units: {
		searchLabel: "유닛 검색",
	...
	users: {
		...
		tabs: { overview: "개요", access: "플랫폼 접근", sessions: "세션", activity: "활동" },
	...
	tokenPolicies: {
		...
		kind: "정책 종류",
		kinds: { standard: "표준", privileged: "특권" },
		...
		updateFailed: "토큰 정책을 업데이트하지 못했습니다. 새로 고친 뒤 다시 시도하세요.",
		save: "정책 저장",
	},
	dashboard: {
