...
export default {
	...
	relationshipManagement: {
		...
		links: "출처 링크",
		linksDescription: "작품 정보의 근거와 참고가 되는 외부 페이지를 관리합니다.",
		variants: "기본 작품과 변형",
		...
		subjectEntity: "내용 대상",
		addLink: "출처 추가",
		addLinkDescription: "출처를 지정하고 공개 참고 페이지를 연결하세요.",
		sourceEntity: "출처",
		...
		noLinks: "아직 출처 링크가 없습니다",
		noLinksDescription: "작품 정보를 뒷받침하는 신뢰할 수 있는 공개 페이지를 추가하세요.",
		...
		removeLinkTitle: "출처 링크를 삭제할까요?",
		removeLinkDescription: insert("{{name}}의 출처 링크를 삭제할까요?", { name: String }),
		removeLinkLabel: insert("{{name}}의 출처 링크 삭제", { name: String }),
		openLinkLabel: insert("{{name}}의 출처 링크 열기", { name: String }),
		creditAdded: "기여자를 추가했습니다",
		subjectAdded: "내용 대상을 추가했습니다",
		linkAdded: "출처 링크를 추가했습니다",
		creditRemoved: "기여자를 삭제했습니다",
		subjectRemoved: "내용 대상을 삭제했습니다",
		linkRemoved: "출처 링크를 삭제했습니다",
	...
	references: {
		title: "커뮤니티 참조 정보",
		description:
			"검색 별칭과 출처 링크를 제안하고 투표할 수 있습니다. 선별된 정보가 먼저, 커뮤니티 투표 순 후보가 그다음에 표시됩니다.",
		aliasesTitle: "별칭",
		aliasesDescription: "이 작품을 더 쉽게 찾을 수 있게 하는 다른 이름입니다.",
		linksTitle: "출처 링크",
		linksDescription: "이 작품의 정보를 뒷받침하는 공개 페이지입니다.",
		aliasTerm: "별칭",
		...
		sourceUrl: `출처 ${verbatimTerms.url.value}`,
		urlPlaceholder: `${verbatimTerms.https.value}://`,
		accepted: "채택됨",
		candidate: "후보",
		pinned: "고정됨",
		...
		linkProposed: "출처 링크를 제안했습니다",
		noAliases: "아직 별칭 후보가 없습니다.",
		noLinks: "아직 출처 링크 후보가 없습니다.",
	},
	contentLanguages: {
		controlLabel: "콘텐츠 언어",
		settings: "언어 설정",
