...
export default {
	...
	content: {
		...
		structureSummary: insert(
			`책 {{books}}권 · {{chapters}} ${koTerminology.chapter.forms.label} · {{labels}} 레이블`,
			{
				books: Number,
				chapters: Number,
				labels: Number,
		...
		mediaStructureSummary: insert(
			`미디어 {{media}}개 · ${videoTerms.label} {{videos}}개 · ${audioTerms.label} {{audios}}개 · 레이블 {{labels}}개`,
		...
		addBookDescription: "기존 책을 검색해 추가합니다. 완료하면 콘텐츠 구조도 함께 저장됩니다.",
		addMediaDescription: "기존 미디어를 검색해 추가합니다. 완료하면 콘텐츠 구조도 함께 저장됩니다.",
		...
		chapterOwnershipOverrideDescription: `이 ${koTerminology.chapter.forms.label}에서 책의 기본값을 덮어씁니다.`,
		addLabelDescription:
		...
		attachBookAndSave: "책 추가 및 저장",
		attachMediaAndSave: "미디어 추가 및 저장",
