...
export default {
	...
	customThemes: `존의 ${customThemeTerms.label} 표시`,
	customThemesHint:
	...
	tokens: {
		...
		limitRanges: insert(
			"허용 범위: 분당 {{requestsMinimum}}~{{requestsMaximum}} 요청; 버스트 용량 {{burstMinimum}}~{{burstMaximum}}; 동시 요청 {{concurrentMinimum}}~{{concurrentMaximum}}; 일일 비용 단위 {{dailyMinimum}}~{{dailyMaximum}}.",
			{
