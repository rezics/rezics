...
export default {
	...
	chapterTitle: `${koTerminology.chapter.forms.label} 제목`,
	chapterContent: `${koTerminology.chapter.forms.label} 내용`,
	position: "위치",
	publishChapter: `${koTerminology.chapter.forms.label} 게시`,
	previousChapter: "이전",
	nextChapter: "다음",
