...
export default {
	...
	nativeMerge: {
		...
		identifiers: "标识符",
		bindings: "来源绑定",
		retainedContent: "来源的属性、关系和结构会保留为证据，不会替换目标的现有内容。",
		retainedAccess:
			"批准此方案后，能够读取目标的人也能读取保留的来源内容。对于私密记录，这可能让原本无权读取来源的人获得访问权。",
		convergence: "批准后，来源会永久跳转至目标。跳转生效后，数据处理仍可能需要单独作出决定。",
		revision: "修订",
		resolved: "已处理项",
		items: "数据处理证据",
		itemState: "证据状态",
		noItems: "没有符合此筛选条件的证据。",
		evidence: "查看证据",
		sourceKey: "来源键",
		semantic: "属性或关系",
		issue: "问题代码",
		...
		bindingPlans: {
			rebind_paused: "迁移绑定至目标并暂停",
			pause_at_source: "在来源暂停绑定",
		},
		visibility: {
			public: "公开",
			unlisted: "不公开列出",
	...
	unitMerges: {
		...
		approveDescription:
			"你的同意票仅适用于当前显示的合并内容。集齐所需同意票后，合并即生效且不可撤销。",
		rejectTitle: "要驳回此条目合并吗？",
		rejectDescription: "一票驳回会永久关闭此申请。",
		reviewNote: "审核备注（可选）",
