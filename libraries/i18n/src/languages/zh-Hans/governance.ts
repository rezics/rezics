...
export default {
	...
	ruleBasis: {
		label: "适用规则",
		description: `请从此治理权限可用的规则${realmTerms.label}中选择至少一条规则，作为不可更改的决策依据。`,
		sourceAriaLabel: `规则${realmTerms.label}`,
		chooseSource: `选择规则${realmTerms.label}`,
		sources: {
			platform: "平台官方规则",
			realm: `${realmTerms.label}规则`,
			local: "本地规则",
		},
		rulesAriaLabel: "适用规则",
		chooseRules: "选择规则",
		clear: "清除所选规则",
		selectedCount: insert("已选择 {{count}} 条规则", { count: Number }),
		loading: "正在加载规则…",
		loadError: "无法加载可用规则，请稍后重试。",
	},
	...
	publisherAttributions: `${zhHansTerminology.publisher.forms.label}标记`,
	publisherAttributionDescription: `如果对方的个人资料允许，可以直接添加${zhHansTerminology.publisher.forms.label}；否则请在下方提出${zhHansTerminology.publisher.forms.label}关联请求。`,
	publisherProfile: `${zhHansTerminology.publisher.forms.label}个人资料`,
	addPublisher: `添加${zhHansTerminology.publisher.forms.label}`,
	removePublisher: `移除${zhHansTerminology.publisher.forms.label}`,
	noPublishers: `尚未标记${zhHansTerminology.publisher.forms.label}。`,
	...
	capabilities: {
		...
		"realm.tag-voting.update": `更新${realmTerms.label}标签投票`,
		"realm.tag-contexts.manage": `管理${realmTerms.label}标签语境关联`,
	...
	access: {
		...
		currentRealmMembersLabel: `此${realmTerms.label}的所有活跃成员`,
		realmMembersLabel: insert("{{realm}}的活跃成员", { realm: String }),
		realmAccessManagersLabel: insert("{{realm}}的访问权限管理员", { realm: String }),
		builtInAudience: "内置对象",
		subjectsTitle: "授权对象",
		...
		subjectRelations: {
			member: `${realmTerms.label}成员`,
			access_manager: `${realmTerms.label}访问权限管理员`,
		},
		table: {
			subject: "授权对象",
			kind: "类型",
		...
		permissions: {
			...
			"realm.tags.manage": `管理${realmTerms.label}标签`,
			"realm.tag-voting.update": "更新标签投票",
			"realm.tag-contexts.manage": "管理标签语境关联",
