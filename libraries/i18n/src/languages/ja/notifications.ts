...
export default {
	center: {
		...
		detailsActorFallback: "関連ユーザー",
		detailsOpenSubject: "関連するユニットを開く",
		detailsOpenActor: insert("{{name}}さんのプロフィールを開く", { name: String }),
		detailsOpenPublicNotice: "公開のお知らせを開く",
		detailsTargetUnavailable: "関連コンテンツは利用できないか、現在アクセス権がありません。",
	},
	followingSettings: {
