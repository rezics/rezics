...
export default {
	...
	localizationFallback: {
		...
		title: "画像の言語フォールバック",
		description: "アバター、バナー、カバーは、テキストに選ばれた言語とは別にそれぞれ解決されます。",
		viewerPreferences:
	...
	presentationEditor: {
		...
		description: {
			avatar:
				"正方形のトリミング内で画像をドラッグしてズームします。円形のアバタープレビューは元の角を削除しません。",
			banner:
				"固定された4:1のトリミング内で画像をドラッグしてズームします。新しいバナーは左上から始まります。",
			cover:
				"デフォルトでは画像全体を保持するか、構図がより重要な場合は固定の3:4トリミングに切り替えます。",
		},
		close: "画像調整を閉じる",
		loading: "元の画像を読み込み中…",
