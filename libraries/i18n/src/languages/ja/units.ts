...
export default {
	...
	references: {
		title: "コミュニティ参照情報",
		description:
			"検索用の別名や出典リンクを提案し、投票できます。選定済みの情報を先に、その後にコミュニティ投票順の候補を表示します。",
		aliasesTitle: "別名",
		aliasesDescription: "この作品を見つけやすくするための別の名称です。",
		linksTitle: "出典リンク",
		linksDescription: "この作品の情報を裏付ける公開ページです。",
		aliasTerm: "別名",
		...
		sourceUrl: `出典${verbatimTerms.url.value}`,
		urlPlaceholder: `${verbatimTerms.https.value}://`,
		accepted: "採用済み",
		candidate: "候補",
		pinned: "固定済み",
		...
		linkProposed: "出典リンクを提案しました",
		noAliases: "別名の候補はまだありません。",
		noLinks: "出典リンクの候補はまだありません。",
	},
	contentLanguages: {
