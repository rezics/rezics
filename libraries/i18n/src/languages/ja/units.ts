...
export default {
	...
	content: {
		...
		attachPost: `既存の${postTerms.label}を追加`,
		attachPostDescription: `閲覧可能な章の${postTerms.label}を選び、この書籍のコンテンツ構造に追加します。${postTerms.label}の所有権や内容は変更されません。`,
		attachPostAction: "コンテンツ構造に追加",
	},
	chapter: {
		title: "章を編集",
