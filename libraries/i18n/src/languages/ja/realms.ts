...
export default {
	...
	feedManagement: {
		...
		addPolicyTagAction: `${realmTerms.label}ポリシータグを追加…`,
		policyTagDescription: `この${realmTerms.label}のポリシーとして適用するタグを検索します。`,
		policyTagsEmpty: `この${realmTerms.label}には、適用できるポリシータグがまだ設定されていません。`,
		configurePolicyTags: "タグ設定を開く",
		applyPolicyTag: "タグを適用",
		policyTagAdded: `${realmTerms.label}ポリシータグを追加しました`,
		loadingModeration: "このコンテンツのモデレーションツールを読み込んでいます。",
		moderationLoadFailed: "このコンテンツのモデレーションツールを読み込めませんでした。",
	},
	...
	governanceActions: {
		...
		invalidate_license: `${jaTerminology.license.forms.label}付与を無効化`,
		restore_license: `${jaTerminology.license.forms.label}付与を復元`,
		warning: "警告",
		silence: "サイレンス",
		suspension: "一時停止",
		ban: "禁止",
