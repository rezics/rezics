...
export default {
	...
	RealmNavigationNotFound: `この${realmTerms.label}ナビゲーションは見つかりませんでした。`,
	RealmNavigationInUse: `この${realmTerms.label}ナビゲーションはまだ使用中です。`,
	RealmNavigationDocumentInvalid: `${realmTerms.label}ナビゲーション文書は無効です。`,
	...
	RealmTagContextNotFound: `この ${realmTerms.label} タグ投票コンテキストが見つかりませんでした。`,
	RealmTagContextPostNotMounted: `タグ投票コンテキスト ${postTerms.label} は ${realmTerms.label} に表示されている必要があります。`,
