...
export default {
	...
	publisherAttributions: `${jaTerminology.publisher.forms.label}クレジット`,
	publisherAttributionDescription: `相手のプロフィールで許可されている場合は${jaTerminology.publisher.forms.label}を直接追加できます。許可されていない場合は、下で${jaTerminology.publisher.forms.label}の関連付けを申請してください。`,
	publisherProfile: `${jaTerminology.publisher.forms.label}プロフィール`,
	addPublisher: `${jaTerminology.publisher.forms.label}を追加`,
	removePublisher: `${jaTerminology.publisher.forms.label}を削除`,
	noPublishers: `${jaTerminology.publisher.forms.label}は登録されていません。`,
