...
export default {
	...
	description: `Entdecke Bücher, ${deTerminology.software.forms.label} und Medien, verfolge deinen Fortschritt und verbessere Einträge gemeinsam im ${realmTerms.inline}.`,
