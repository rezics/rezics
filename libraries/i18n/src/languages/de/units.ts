...
export default {
	...
	content: {
		...
		structureSummary: insert(
			`{{books}} Bücher · {{chapters}} ${deTerminology.chapter.forms.label} · {{labels}} Bezeichnungen`,
			{
				books: Number,
				chapters: Number,
				labels: Number,
		...
		chapterOwnershipOverrideDescription: `Die Eigentumsform des Buchs für dieses ${deTerminology.chapter.forms.label} überschreiben.`,
		addLabelDescription:
