...
export default {
	...
	relationshipManagement: {
		...
		links: "Quellenlinks",
		linksDescription: "Externe Belege und Referenzseiten, die mit diesem Werk verbunden sind.",
		...
		addLink: "Quelle hinzufügen",
		addLinkDescription: "Quelle angeben und ihre öffentliche Referenzseite verlinken.",
		sourceEntity: "Quelle",
		...
		noLinks: "Noch keine Quellenlinks",
		noLinksDescription:
		...
		removeLinkTitle: "Quellenlink entfernen?",
		removeLinkDescription: insert("Den Quellenlink von {{name}} entfernen?", { name: String }),
		removeLinkLabel: insert("Quellenlink von {{name}} entfernen", { name: String }),
		openLinkLabel: insert("Quellenlink von {{name}} öffnen", { name: String }),
		creditAdded: "Mitwirkung hinzugefügt",
		subjectAdded: "Inhaltlicher Bezug hinzugefügt",
		linkAdded: "Quellenlink hinzugefügt",
		creditRemoved: "Mitwirkung entfernt",
		subjectRemoved: "Inhaltlicher Bezug entfernt",
		linkRemoved: "Quellenlink entfernt",
	...
	references: {
		...
		description:
			"Schlagen Sie Suchaliasnamen und Quellenlinks vor und stimmen Sie darüber ab. Kuratierte Referenzen stehen zuerst, danach stehen gemeinschaftlich bewertete Kandidaten.",
		aliasesTitle: "Aliasnamen",
		aliasesDescription: "Alternative Namen, unter denen dieses Werk gefunden werden kann.",
		linksTitle: "Quellenlinks",
		linksDescription: "Öffentliche Seiten, die Angaben zu diesem Werk belegen.",
		aliasTerm: "Aliasname",
		aliasPlaceholder: "Alternativen Namen eingeben",
		proposeAlias: "Aliasnamen vorschlagen",
		proposeLink: "Quelle vorschlagen",
		sourceEntity: "Quelleneintrag",
		sourcePlaceholder: "Quelleneintrag auswählen",
		sourceUrl: `Quellen-${verbatimTerms.url.value}`,
		urlPlaceholder: `${verbatimTerms.https.value}://`,
		accepted: "Angenommen",
		candidate: "Kandidat",
		pinned: "Angeheftet",
		...
		linkProposed: "Quellenlink vorgeschlagen",
		noAliases: "Noch keine Alias-Kandidaten.",
		noLinks: "Noch keine Quellenlink-Kandidaten.",
	},
	contentLanguages: {
