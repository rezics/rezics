...
export default {
	...
	InvalidTagPathMerge: `Die Zusammenführung dieses ${tagPathTerms.inline} ist ungültig.`,
	TagPathMergeNotFound: `Der Zusammenführungsvorschlag für diesen ${tagPathTerms.inline} wurde nicht gefunden.`,
