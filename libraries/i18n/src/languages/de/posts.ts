...
export default {
	...
	contentSpoilerLabel: "Spoilergrad des Inhalts",
	contentSpoilerNone: "Keine Spoiler",
	contentSpoilerMinor: "Leichte Spoiler",
	contentSpoilerMajor: "Erhebliche Spoiler",
	contentNsfwLabel: "Sensible Inhalte",
	contentNsfwDescription:
		"Kennzeichnet Inhalte, die sich nicht zur Anzeige in der Öffentlichkeit eignen.",
	revealNsfw: "Sensible Inhalte anzeigen",
	...
	wikiCommunityUnit: "Öffentlicher Eintrag",
	...
	openExcerptComposer: "Auszug hinzufügen",
	...
	publishRealms: `In ${realmTerms.pluralLabel} veröffentlichen`,
	publishRealmsHint: `In mehreren ${realmTerms.pluralLabel} veröffentlichen; ohne Auswahl wird der Inhalt global veröffentlicht.`,
	removePublishRealm: `${realmTerms.label} als Veröffentlichungsziel entfernen`,
	publishRealmsLimit: `Inhalte können in höchstens 10 ${realmTerms.pluralLabel} veröffentlicht werden.`,
	globalContext: "Global",
	selectRealmContext: `${realmTerms.label} als Kontext auswählen`,
	realmContextCard: `${realmTerms.label}-Informationen`,
	realmSummary: `Über diesen ${realmTerms.inline}`,
	subject: "Gegenstand",
