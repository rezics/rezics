...
export default {
	...
	tokens: {
		...
		limitRanges: insert(
			"Zulässige Bereiche: {{requestsMinimum}} bis {{requestsMaximum}} Anfragen pro Minute; {{concurrentMinimum}} bis {{concurrentMaximum}} gleichzeitige Anfragen; {{dailyMinimum}} bis {{dailyMaximum}} tägliche Kosteneinheiten.",
			{
	...
	defaultScoreContext: "Standardmäßiger Bewertungskontext",
	defaultScoreContextHint: `Bewertungen von allgemeinen Seiten verwenden diesen Kontext. Bewertungen, die in einem anderen ${realmTerms.inline} erstellt werden, behalten diesen Kontext bei.`,
	general: "Allgemein",
