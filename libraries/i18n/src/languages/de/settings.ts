...
export default {
	...
	participation: {
		...
		recipient: "Öffentliche Identität des Kontos",
		permission: "Berechtigung",
		expiresAt: "Gültig bis",
		revoke: "Widerrufen",
		revoked: "Widerrufen",
		grants: "Zugriffsrechte",
		noGrants: "Keine Zugriffsrechte.",
		...
		capabilities: {
			"catalog.read": "Einträge lesen",
			"catalog.edit": "Einträge bearbeiten",
			"entity.publish": "Unter dieser Identität veröffentlichen",
			"entity.membership": "Mitglieder verwalten",
			"entity.security": "Sicherheit verwalten",
			"proposal.adopt": "Eine Quellenänderung genehmigen",
		},
	},
	workspace: {
		title: "Einstellungen",
