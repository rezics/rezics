...
export default {
	...
	ruleBasis: {
		label: "Anwendbare Regeln",
		description:
			"Wähle mindestens eine Regel aus den für diese Governance-Befugnis verfügbaren Regelbereichen. Die Auswahl wird zur unveränderlichen Entscheidungsgrundlage.",
		sourceAriaLabel: "Regelbereich",
		chooseSource: "Regelbereich auswählen",
		sources: {
			platform: "Offizielle Plattformregeln",
			realm: `Regeln des ${realmTerms.label}s`,
			local: "Lokale Regeln",
		},
		rulesAriaLabel: "Anwendbare Regeln",
		chooseRules: "Regeln auswählen",
		clear: "Ausgewählte Regeln löschen",
		selectedCount: insert("{{count}} Regeln ausgewählt", { count: Number }),
		loading: "Regeln werden geladen…",
		loadError: "Die verfügbaren Regeln konnten nicht geladen werden. Versuche es später erneut.",
	},
