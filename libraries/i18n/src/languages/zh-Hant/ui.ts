...
export default {
	...
	chapterTitle: `${zhHantTerminology.chapter.forms.label}標題`,
	chapterContent: `${zhHantTerminology.chapter.forms.label}內容`,
	position: "排序",
	publishChapter: `發布${zhHantTerminology.chapter.forms.label}`,
	previousChapter: "上一章",
	nextChapter: "下一章",
	backToUnit: "返回作品",
	markRead: "標記已讀",
