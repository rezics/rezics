...
export default {
	...
	contentSpoilerLabel: "內容劇透程度",
	contentSpoilerNone: "無劇透",
	contentSpoilerMinor: "輕微劇透",
	contentSpoilerMajor: "重大劇透",
	contentNsfwLabel: "不宜公開顯示",
	contentNsfwDescription: "標示可能不適合在公共場合顯示的內容。",
	revealNsfw: "顯示不宜公開顯示的內容",
	...
	publishRealms: `發佈${realmTerms.pluralLabel}`,
	publishRealmsHint: `可發佈到多個${realmTerms.label}；不選擇則發佈到全域。`,
	removePublishRealm: `移除發佈${realmTerms.label}`,
	publishRealmsLimit: `每篇內容最多可發佈到 10 個${realmTerms.label}。`,
	globalContext: "全域",
