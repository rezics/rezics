...
export default {
	AccessChanged: "權限或資料已變更，請重新整理後再試。",
	AccessDenied: "你沒有執行此操作的權限。",
	AccessInputInvalid: "請檢查你的選擇後再試。",
	AccessRecordUnavailable: "此項目無法使用。",
	AccessUnavailable: "目前無法確認你的權限，請再試一次。",
	...
	SoftwareSystemRequirementSourceInvalid: `系統需求來源必須屬於這個${zhHantTerminology.software.forms.label}。`,
	...
	SoftwareNotFound: `找不到這個${zhHantTerminology.software.forms.label}。`,
	...
	ChapterNotFound: `找不到這個${zhHantTerminology.chapter.forms.label}。`,
	ChapterLanguageNotFound: `找不到該${zhHantTerminology.chapter.forms.label}的語言版本。`,
