...
export default {
	...
	publicEntrySearch: {
		...
		requiredDescription: "完成搜尋後，才能提交這個公共條目。",
		prompt: insert("搜尋現有{{subject}}", { subject: String }),
		confirmedTitle: insert("已搜尋現有{{subject}}", { subject: String }),
		confirmedDescription: "目前標題已完成搜尋；若更改標題或類別，必須重新搜尋。",
		...
		searchAction: "搜尋",
		searchHint: "輸入名稱並執行搜尋，系統才會提供建立選項。",
		searchFailed: "搜尋暫時無法使用。請重試；搜尋成功前不能建立公共條目。",
