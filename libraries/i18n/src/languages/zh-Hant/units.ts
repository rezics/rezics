...
export default {
	...
	relationshipManagement: {
		...
		links: "來源連結",
		linksDescription: "連結與作品資訊相關的外部佐證與參考頁面。",
		variants: "主作品與變體",
		...
		subjectEntity: "內容主體",
		addLink: "新增來源",
		addLinkDescription: "指定來源，並連結到其公開參考頁面。",
		sourceEntity: "來源",
		...
		noLinks: "尚無來源連結",
		noLinksDescription: "新增可佐證這項作品資訊的可靠公開頁面。",
		noVariants: "尚無變體",
		...
		removeLinkTitle: "要移除來源連結嗎？",
		removeLinkDescription: insert("要移除來自{{name}}的來源連結嗎？", { name: String }),
		removeLinkLabel: insert("移除來自{{name}}的來源連結", { name: String }),
		openLinkLabel: insert("開啟來自{{name}}的來源連結", { name: String }),
		creditAdded: "已新增署名",
	...
	references: {
		title: "社群參考資料",
		description: "提名並票選搜尋別名與來源連結。精選資料優先顯示，其後依社群票選排序。",
		aliasesTitle: "別名",
		aliasesDescription: "協助讀者找到這個作品的其他名稱。",
		linksTitle: "來源連結",
		linksDescription: "可佐證這個作品資訊的公開頁面。",
		aliasTerm: "別名",
