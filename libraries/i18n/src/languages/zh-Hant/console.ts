...
export default {
	...
	nativeMerge: {
		...
		identifiers: "識別碼",
		bindings: "來源綁定",
		retainedContent: "來源的屬性、關係和結構會保留為證據，不會取代目標的現有內容。",
		retainedAccess:
			"核准此方案後，能夠讀取目標的人也能讀取保留的來源內容。對於私密記錄，這可能讓原本無權讀取來源的人取得存取權。",
		convergence: "核准後，來源會永久重新導向目標。重新導向生效後，資料處理仍可能需要個別決定。",
		revision: "修訂",
		resolved: "已處理項目",
		items: "資料處理證據",
		itemState: "證據狀態",
		noItems: "沒有符合此篩選條件的證據。",
		evidence: "檢視證據",
		sourceKey: "來源鍵",
		semantic: "屬性或關係",
		issue: "問題代碼",
		...
		bindingPlans: {
			rebind_paused: "移轉綁定至目標並暫停",
			pause_at_source: "在來源暫停綁定",
		},
		visibility: {
			public: "公開",
			unlisted: "不公開列出",
	...
	unitMerges: {
		...
		submitForReview: "送交審核",
		approveTitle: "要同意這項條目合併嗎？",
		approveDescription:
			"你的同意票僅適用於目前顯示的合併內容。集齊所需同意票後，合併即生效且無法復原。",
		rejectTitle: "要駁回這項條目合併嗎？",
		rejectDescription: "一票駁回會永久關閉此申請。",
		reviewNote: "審核備註（選填）",
