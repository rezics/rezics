...
export default {
	...
	shelf: {
		...
		previous: "Elementos anteriores",
		next: "Elementos siguientes",
		page: insert("Página {{page}} de {{pageCount}}", { page: Number, pageCount: Number }),
		item: insert("Elemento {{item}} de {{itemCount}}", { item: Number, itemCount: Number }),
	},
	pickerPlaceholders: {
	...
	chapterTitle: `Título del ${esTerminology.chapter.forms.inline}`,
	chapterContent: `Contenido del ${esTerminology.chapter.forms.inline}`,
	position: "Posición",
	publishChapter: `Publicar ${esTerminology.chapter.forms.inline}`,
