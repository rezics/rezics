...
export default {
	...
	publishRealms: `${realmTerms.pluralLabel} de destino`,
	publishRealmsHint: `Comparte en varios ${realmTerms.pluralLabel}; si no eliges ninguno, el contenido estará disponible globalmente.`,
	removePublishRealm: `Quitar ${realmTerms.inline} de los destinos`,
	publishRealmsLimit: `El contenido puede publicarse en un máximo de 10 ${realmTerms.pluralLabel}.`,
