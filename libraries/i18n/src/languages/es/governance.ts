...
export default {
	...
	capabilities: {
		...
		"unit.merge": "Gestionar fusiones de Units",
	...
	access: {
		...
		permissions: {
			"unit.read": "Leer",
			"unit.update": "Editar",
			"unit.metadata-only.update": "Cambiar la disponibilidad del contenido completo",
			...
			"zone.pages.manage": `Gestionar las páginas y la navegación de la ${zoneTerms.inline}`,
			"zone.theme.manage": `Gestionar la apariencia de la ${zoneTerms.inline}`,
