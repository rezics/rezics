...
export default {
	...
	UnitMergeNotFound: "No se encontró esta solicitud de fusión de Units.",
	UnitMergeConfirmationInvalid: "La confirmación del origen o del destino no coincide.",
	...
	UnitMergeReviewSelfForbidden: "No puedes revisar una fusión de Units que hayas propuesto.",
	UnitMergeReviewDuplicate: "Ya has revisado esta fusión de Units.",
	UnitMergeReviewFingerprintMismatch:
		"Esta revisión corresponde a un manifiesto de fusión anterior.",
	UnitMergeRequestNotPending: "Esta fusión de Units ya no está pendiente de revisión.",
	UnitMergeRequestExpired: "Esta solicitud de fusión de Units ha caducado.",
	UnitMergeRetryUnavailable: "Esta fusión de Units no puede reintentarse en su estado actual.",
	...
	InvalidTagPathMerge: `La fusión de esta ${tagPathTerms.inline} no es válida.`,
	TagPathMergeNotFound: `No se ha encontrado la propuesta de fusión de esta ${tagPathTerms.inline}.`,
