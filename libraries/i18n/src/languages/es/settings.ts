...
export default {
	...
	participation: {
		...
		sourceChange: "Cambio de fuente",
		history: "Historial",
		restore: "Restaurar",
		title: "Organizaciones y acceso",
		description: "Crea organizaciones y administra sus identidades públicas y permisos delegados.",
		organizations: "Organizaciones",
		createOrganization: "Crear organización",
		name: "Nombre",
		manage: "Administrar acceso",
		identity: "Identidad que actúa",
		grantAccess: "Conceder acceso",
		recipient: "Identidad pública de la cuenta",
		permission: "Permiso",
		expiresAt: "Caduca el",
		revoke: "Revocar",
		revoked: "Revocado",
		grants: "Permisos de acceso",
		noGrants: "No hay permisos de acceso.",
		services: "Identidades de automatización",
		createService: "Crear identidad de automatización",
		credential: "Credencial",
		credentialDescription: "Copia esta credencial ahora. No volverá a mostrarse después de cerrar.",
		securityWarning: "Revocar al último responsable humano de seguridad suspende esta identidad hasta que la plataforma verifique su recuperación.",
		revokeWarning: "Este permiso dejará de funcionar inmediatamente. Se conservará el registro de las acciones completadas.",
		erasedRecipient: "Cuenta eliminada",
		currentAccount: "Mi identidad",
		eraseTitle: "Eliminar cuenta",
		eraseDescription: "El inicio de sesión se deshabilitará de inmediato. Las notas privadas, favoritos, avances, mensajes y archivos subidos se eliminarán por lotes. La autoría pública y los registros de auditoría se conservarán. Esta acción es irreversible.",
		eraseConfirmation: "Entiendo que no se podrán recuperar mi cuenta ni mis datos privados.",
		erase: "Eliminar mi cuenta",
		erased: "Ha comenzado la eliminación de la cuenta.",
		capabilities: {
			"catalog.read": "Leer registros",
			"catalog.edit": "Editar registros",
			"entity.publish": "Publicar con esta identidad",
			"entity.membership": "Administrar miembros",
			"entity.security": "Administrar seguridad",
			"proposal.adopt": "Aprobar un cambio de fuente",
		},
	},
	workspace: {
		title: "Configuración",
