...
export default {
	...
	relationshipManagement: {
		...
		links: "Enlaces de fuentes",
		linksDescription: "Pruebas externas y páginas de referencia relacionadas con esta obra.",
		...
		subjectEntity: "Tema",
		addLink: "Añadir fuente",
		addLinkDescription: "Identifica la fuente y enlaza su página pública de referencia.",
		sourceEntity: "Fuente",
		...
		noLinks: "Aún no hay enlaces de fuentes",
		noLinksDescription:
		...
		removeLinkTitle: "¿Eliminar el enlace de la fuente?",
		removeLinkDescription: insert("¿Eliminar el enlace de la fuente {{name}}?", {
			name: String,
		}),
		removeLinkLabel: insert("Eliminar el enlace de la fuente {{name}}", { name: String }),
		openLinkLabel: insert("Abrir el enlace de la fuente {{name}}", { name: String }),
		creditAdded: "Crédito añadido",
		subjectAdded: "Tema añadido",
		linkAdded: "Enlace de fuente añadido",
		creditRemoved: "Crédito eliminado",
		subjectRemoved: "Tema eliminado",
		linkRemoved: "Enlace de fuente eliminado",
	...
	references: {
		...
		description:
			"Propón alias de búsqueda y enlaces de fuentes y vótalos. Las referencias seleccionadas aparecen primero, seguidas de las candidatas ordenadas por la comunidad.",
		aliasesTitle: "Alias",
		aliasesDescription: "Nombres alternativos que ayudan a encontrar esta obra.",
		linksTitle: "Enlaces de fuentes",
		linksDescription: "Páginas públicas que respaldan la información sobre esta obra.",
		aliasTerm: "Alias",
		aliasPlaceholder: "Introduce un nombre alternativo",
		proposeAlias: "Proponer alias",
		proposeLink: "Proponer fuente",
		sourceEntity: `${entityTerms.label} de origen`,
		sourcePlaceholder: `Elige ${entityTerms.inline} de origen`,
		sourceUrl: `${verbatimTerms.url.value} de la fuente`,
		urlPlaceholder: `${verbatimTerms.https.value}://`,
		accepted: "Aceptada",
		candidate: "Candidata",
		pinned: "Fijada",
		...
		linkProposed: "Enlace de fuente propuesto",
		noAliases: "Aún no hay candidatos de alias.",
		noLinks: "Aún no hay candidatos de enlaces de fuentes.",
	},
	contentLanguages: {
