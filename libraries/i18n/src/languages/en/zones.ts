...
export default {
	...
	management: {
		...
		search: {
			...
			labelUnitId: `Custom label content ${verbatimTerms.id.value}`,
			allowedTagIds: `Allowed tag ${verbatimTerms.id.value} values`,
			allowedTagIdsPlaceholder: `Comma-separated tag ${verbatimTerms.id.value} values; leave empty to allow all`,
		...
		navigationEditor: {
			...
			labelUnitId: `Label content ${verbatimTerms.id.value}`,
			targetKind: "Target type",
			targetKinds: { unit: "Content", external: "External website" },
			targetUnitId: `Target content ${verbatimTerms.id.value}`,
