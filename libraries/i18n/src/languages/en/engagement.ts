...
export default {
	...
	progressByType: {
		...
		generic: {
			...
			summaryTitle: "My progress",
			progressLabel: "Completion",
			dialogDescription:
				"Record your status and progress. Completing this adds one to your completions.",
			listSummary: insert("{{percent}}% complete · {{count}} completions", {
				percent: Number,
				count: Number,
			}),
			status: "Status",
			...
			history: {
				completion: insert("Completed this on {{date}}.", { date: String }),
				update: insert("Reached {{percent}}% on {{date}}.", {
					date: String,
					percent: Number,
				}),
			},
			scoreAction: "Rate this",
			recordAction: "Record progress",
			startAction: "Start",
			updateAction: "Update progress",
			resumeAction: "Resume",
			startAgainAction: "Start again",
			restartAction: "Start over",
			completeAction: "Complete this",
			completedFeedback: insert("Completion {{count}}", { count: Number }),
			statistics: {
				active: insert("{{count}} people currently have this in progress", { count: String }),
				activeOne: "1 person currently has this in progress",
				backlog: insert("{{count}} people want to start this", { count: String }),
				backlogOne: "1 person wants to start this",
			},
			statuses: {
				backlog: "Want to start",
				active: "In progress",
				paused: "Paused",
				completed: "Completed",
				dropped: "Stopped",
