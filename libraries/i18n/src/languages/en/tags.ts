...
export default {
	...
	picker: {
		open: insert("Review {{tag}} before adding", { tag: String }),
		close: "Close Tag details",
		path: tagPathTerms.label,
		remove: insert("Remove {{tag}} from the pending Tags", { tag: String }),
		searchMore: "Search for another Tag",
		loading: "Searching Tags…",
		searchError: "Tags could not be searched. Try again.",
		directResults: "Tags",
		pathResults: `${tagPathTerms.pluralLabel} with matching meanings`,
		noResults: `No matching Tags or ${tagPathTerms.plural}.`,
		addSelected: insert("Add selected Tags ({{count}})", { count: Number }),
		selectedCount: insert("{{count}} pending selections", { count: Number }),
		commitError: "Some Tags could not be added. The failed selections are still here to retry.",
	},
	basic: {
		title: "Basic Tags",
	...
	create: {
		...
		duplicateDescription:
			"Matching Tags appear automatically as you edit the title, so you can reuse one instead of creating a duplicate.",
		duplicateSearching: "Checking existing Tags…",
		duplicateSearchError: "Existing Tags could not be checked. Try editing the title or try again.",
		duplicateMatches: "Possible matches",
		duplicateNoMatches: "No matching existing Tag was found.",
		useExisting: "Use this Tag",
		viewExisting: "View Tag",
		exactDuplicateBlocked: "A Tag with this title already exists. Use the existing Tag instead.",
		duplicateConfirmed: "You confirmed that none of these Tags is the one you need.",
		continueDistinct: "None match; create a new Tag",
		useExistingError: "The existing Tag could not be applied. Try again.",
	},
	global: {
