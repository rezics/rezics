...
export default {
	...
	paths: {
		...
		description: `${tagPathTerms.pluralLabel} preserve meaningful hierarchy and are shown before flat Tags.`,
		addTitle: `Add a ${tagPathTerms.inline}`,
		addDescription: `Search accepted ${tagPathTerms.plural} first. Adding one supports the path and every Tag on it.`,
