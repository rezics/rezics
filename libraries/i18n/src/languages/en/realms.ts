...
export default {
	...
	feedManagement: {
		...
		addPolicyTagAction: `Add ${realmTerms.label} policy Tag…`,
		policyTagDescription: `Search for a Tag to apply under this ${realmTerms.inline}'s policy authority.`,
		policyTagsEmpty: `This ${realmTerms.label} has no applicable policy Tags configured yet.`,
		configurePolicyTags: "Go to Tag settings",
		applyPolicyTag: "Apply Tag",
		policyTagAdded: `${realmTerms.label} policy Tag added`,
		loadingModeration: "Loading the moderation tools for this content.",
		moderationLoadFailed: "The moderation tools for this content could not be loaded.",
	},
	...
	governanceActions: {
		...
		invalidate_license: `Invalidate ${enTerminology.license.forms.inline} grant`,
		restore_license: `Restore ${enTerminology.license.forms.inline} grant`,
		warning: "Warning",
		silence: "Silence",
		suspension: "Suspend",
		ban: "Ban",
