...
export default {
	...
	customThemes: `Show custom ${zoneTerms.label} themes`,
	customThemesHint: `When off, every ${zoneTerms.label} uses the platform default theme. Content and layout are unchanged.`,
	account: "Account",
