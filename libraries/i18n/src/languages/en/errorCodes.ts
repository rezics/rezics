...
export default {
	...
	UnitLicenseGrantForbidden: `Only personally owned works can grant a ${enTerminology.license.forms.inline} to ${verbatimTerms.rezics.value}.`,
	UnitLicenseNotApplicable: `This ${enTerminology.license.forms.inline} cannot be granted on this kind of content.`,
	...
	ContentGovernanceTargetNotFound: "The content-governance target could not be found.",
	ContentReviewRealmMissing: `This content-review case is missing its ${realmTerms.label}.`,
	ContentReviewCaseNotFound: "This content-review case could not be found.",
	ContentGovernanceReversedActionInvalid: "The reversed action does not belong to this case.",
	ContentGovernanceActionIncompatible:
		"This action is not available for the content-governance target.",
	ContentGovernanceTransitionInvalid:
		"The target cannot make that content-governance state transition.",
	ContentGovernanceActionNoEffect: "The content-governance action would not change the target.",
	ContentGovernanceReversalUnavailable: "This action can no longer be reversed safely.",
	ContentGovernanceIdempotencyConflict:
		"This retry key was already used for a different content-governance request.",
	GovernanceNoteRoleDuplicate: "Add at most one internal note and one public notice.",
	...
	UnitMergeNotFound: "This Unit merge request could not be found.",
	UnitMergeConfirmationInvalid: "The source or target confirmation does not match.",
	...
	UnitMergeReviewDuplicate: "You have already reviewed this Unit merge.",
	UnitMergeReviewFingerprintMismatch: "This review refers to an older merge manifest.",
	UnitMergeRequestNotPending: "This Unit merge is no longer awaiting review.",
	UnitMergeRequestExpired: "This Unit merge request has expired.",
	UnitMergeRetryUnavailable: "This Unit merge cannot be retried in its current state.",
