...
export default {
	...
	PlatformGrantRealmForbidden: `Platform grants cannot be scoped to a ${realmTerms.label}.`,
	RealmGrantRealmRequired: `Choose a ${realmTerms.label} for this grant.`,
	RealmGrantCapabilityInvalid: `This capability cannot be granted in a ${realmTerms.label}.`,
