...
export default {
	...
	references: {
		...
		linkProposed: "Source link proposed",
		noAliases: "No alias candidates yet.",
		noLinks: "No source-link candidates yet.",
	},
	contentLanguages: {
