...
export default {
	...
	chapterTitle: `${enTerminology.chapter.forms.label} title`,
	chapterContent: `${enTerminology.chapter.forms.label} content`,
	position: "Position",
	publishChapter: `Publish ${enTerminology.chapter.forms.inline}`,
