import { realmUnitStatus, realmUnitPublicationState } from "../realms/realm-values";
...
import { unitRevision } from "../history/history";
import { post } from "../forum/post";
import { realm, realmRule, realmRuleRevision, realmUnit } from "../realms/realm";
import { unitLicenseGrant, unitLicenseRecognitionStatus } from "../documents/unit";
...
export const governancePostBinding = pgTable(
	...
	(table) => [
		index("governance_post_binding_subject_idx").on(
			table.subjectKind,
			table.subjectId,
			table.postId.desc(),
		),
