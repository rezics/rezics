...
export const accessRoleBinding = pgTable(
	...
	(table): PgTableExtraConfigValue[] => [
		...
		index("access_role_binding_group_page_idx")
		...
		index("access_role_binding_recipient_scope_page_idx")
		...
		index("access_role_binding_subject_page_idx")
...
export const accessRoleBindingRevision = pgTable(
	...
	(table) => [
		...
		index("access_role_binding_selection_page_idx")
			.on(table.selectionGroupId, table.bindingId, table.revision)
