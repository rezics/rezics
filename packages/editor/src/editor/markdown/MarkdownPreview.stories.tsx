...
type Args = { viewMode: ViewMode };

function ViewModesRender({ viewMode }: Args) {
  return (
    <MarkdownEditor
      key={viewMode}
...
const meta = {
  title: "Editor/Markdown/Preview",
  args: { viewMode: "write" },
  argTypes: {
    viewMode: { control: "radio", options: ["write", "preview", "dual"] },
  },
} satisfies Meta<Args>;
...
export const ViewModes: Story = {
  render: (args) => <ViewModesRender {...args} />,
};
...
export const NovelFormatting: Story = {
  render: () => (
