#!/usr/bin/env bun
/**
 * Read `packages/i18n/messages/en.json` and group keys by identical value.
 ...
 *
 * 读取 `packages/i18n/messages/en.json`，并按相同值将键分组。
...
const EN_PATH = join(REPO_ROOT, "packages/i18n/messages/en.json");
