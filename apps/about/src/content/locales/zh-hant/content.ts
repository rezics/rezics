...
export const zhHantContent = {
	...
	meta: {
		...
		products: {
			title: `產品 — ${BRAND}`,
			description: `以原生多語言單元作為共同基礎，再透過跨語言書單、標籤與社群分類、維基及${REALM}，讓作品跨越語言、平台與社群持續累積價值。`,
		},
	},
	home: {
		eyebrow: "傳承 · 創作 · 傳播",
		...
		v1: {
			...
			foundation: {
				...
				pillars: [
					{
						title: "原生多語言單元",
						body: "同一個作品身份承載各語呈現、平台來源、主條目／變體與合併治理。",
					},
					{
						title: "內容結構",
	...
	uses: {
		...
		journeys: [
			...
			{
				title: "用熟悉的語言找到並理解它",
				body: "原名、羅馬字與社群慣用名共同成為搜尋入口；進入同一個單元後，再顯示符合讀者偏好的名稱、摘要與內容。",
	...
	products: {
		...
		lead: `每部作品先以原生多語言單元保存各語呈現、關係與修訂，再由跨語言書單、標籤與社群分類、維基及${REALM}帶到不同語言的讀者與社群。`,
		openProduct: "查看產品",
		stage: {
			legend: "產品狀態",
			current: "目前狀態",
