...
export const jaContent = {
	...
	home: {
		eyebrow: "継承 · 創作 · 伝播",
		title: "好きな物語に出会う。",
		lead: `${BRAND} は作品を中心にした多言語知識ネットワークです。作品の識別、版、内容、議論、コミュニティの記憶を、別々の項目へ分断せずにつなぎます。`,
		explore: "使い方を見る",
		understand: "仕組みを知る",
		problem: {
		...
		principles: [
			{
				title: "継承",
				body: "作品が受け継いだ歴史、言語、版、コミュニティの記憶を受け取ります。",
			},
		...
		outcomes: {
			title: "読者と、作品を未来へつなぐすべての人へ。",
			body: "発見の負担を減らし、創作の帰属を守り、知識を次の読者へ届けます。",
			cards: [
