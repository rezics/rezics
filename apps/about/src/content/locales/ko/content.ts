...
export const koContent = {
	...
	home: {
		...
		lead: `${BRAND}는 작품을 중심으로 한 다국어 지식 네트워크입니다. 작품의 정체성, 릴리스, 콘텐츠, 토론, 커뮤니티 기억을 서로 낯선 플랫폼과 항목으로 흩뜨리지 않고 연결합니다.`,
		explore: "활용 살펴보기",
		understand: "원리 이해하기",
		problem: {
		...
		principles: [
			{
				title: "이어받기",
				body: "작품이 이미 가진 역사, 언어, 릴리스, 커뮤니티 기억을 이어받습니다.",
			},
			{
				title: "만들기",
		...
		outcomes: {
			title: "독자와 작품을 함께 지키는 모든 사람을 위해.",
			body: "같은 기반이 탐색 비용을 줄이고 창작 귀속을 보존하며 커뮤니티 지식을 다음 독자에게 전합니다.",
			cards: [
