...
export const koContent = {
	...
	meta: {
		...
		products: {
			title: `제품 — ${BRAND}`,
			description: `언어를 넘는 책 목록, 태그와 커뮤니티 분류, 위키, ${REALM}으로 작품을 찾고 이해하고 모으며 함께 이어 갑니다.`,
		},
	},
	home: {
		eyebrow: "전승 · 창작 · 전파",
	...
	products: {
		...
		lead: `언어를 넘는 책 목록, 태그와 커뮤니티 분류, 위키, ${REALM}은 모두 같은 작품으로 이어집니다. 새로운 이름, 출처, 콘텐츠, 커뮤니티가 더해질수록 그 작품의 가치는 함께 커집니다.`,
		openProduct: "제품 보기",
		stage: {
			legend: "제품 상태",
			current: "현재 상태",
