...
import { PublicEntrySearchPage } from "./public-entry-search-page";
...
describe("PublicEntrySearchPage", () => {
	...
	it("uses the Tag domain without sending the unsupported kind filter", async () => {
		render(
			<PublicEntrySearchPage initialQuery="science" subject={TagPublicEntrySearchSubject} />,
		);
