...
export const CatalogDetailSections = {
	book: ["overview", "contents", "reviews", "discussion", "editions"],
	media: ["overview", "reviews", "discussion", "versions"],
	software: ["overview", "requirements", "reviews", "discussion", "versions"],
