		...
		<UiProvider
			...
			messages={{
				...
				editor: {
					...
					spoiler: t.editor.spoiler,
					addSpoiler: t.editor.addSpoiler,
					removeSpoiler: t.editor.removeSpoiler,
					showSpoiler: t.editor.showSpoiler,
					showScopedSpoiler: t.editor.showScopedSpoiler,
					spoilerPreview: t.editor.spoilerPreview,
					spoilerScope: t.editor.spoilerScope,
					spoilerScopePlaceholder: t.editor.spoilerScopePlaceholder,
					spoilerRange: t.editor.spoilerRange,
					spoilerRangeSelection: t.editor.spoilerRangeSelection,
					spoilerRangeBlocks: t.editor.spoilerRangeBlocks,
					spoilerRangeBody: t.editor.spoilerRangeBody,
					spoilerLinkConflict: t.editor.spoilerLinkConflict,
					spoilerTextOnlyHint: t.editor.spoilerTextOnlyHint,
					undo: t.editor.undo,
					redo: t.editor.redo,
