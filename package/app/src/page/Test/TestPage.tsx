...
export default function PersistentTabs() {
  ...
  const { data, isLoading, error } = useRpcQuery<any>(createChapterListInput);
  ...
  const { data: testData, isLoading: testLoading, error: testError } = useRpcQuery<any>(createTestInput);
