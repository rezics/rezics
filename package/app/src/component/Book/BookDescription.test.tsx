...
export default () => {
    const [props] = useFixtureInput<Parameters<typeof BookDescription>[0]>("Props", {
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        <div className="border rounded p-2">
                            <BookDescription description="这是一本精彩的小说。" />
                        </div>
                        <div className="border rounded p-2">
                            <BookDescription description="这是一本关于魔法世界的奇幻小说，讲述了一个年轻巫师的成长故事。作品充满了想象力和创意，深受读者喜爱。" />
                        </div>
                    </div>
                </div>
            </div>
