    ...
    if (textareaRef.current) {
      ...
      easyMDEInstance.current = new EasyMDE({
        ...
        toolbar: [
          ...
          { name: 'heading', action: EasyMDE.toggleHeadingSmaller, className: 'bx bx-heading', title: 'Heading' },
          '|',
          { name: 'quote', action: EasyMDE.toggleBlockquote, className: 'bx bxs-quote-alt-right', title: 'Quote' },
          { name: 'unordered-list', action: EasyMDE.toggleUnorderedList, className: 'bx bx-list-ul', title: 'Generic List' },
          { name: 'ordered-list', action: EasyMDE.toggleOrderedList, className: 'bx bx-list-ol', title: 'Numbered List' },
          '|',
          ...
          '|',
          { name: 'preview', action: EasyMDE.togglePreview, className: 'bx bx-show no-disable', title: 'Toggle Preview' },
          {
              name: 'side-by-side',
          ...
          { name: 'guide', action: () => { window.open('https://www.markdownguide.org/basic-syntax/', '_blank'); }, className: 'bx bx-help-circle no-disable', title: 'Markdown Guide'}
        ],
      });
