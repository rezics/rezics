export default {
  ...
  page: {
    home: {
      ...
      discovery: {
        ...
        featured_shelves_subtitle: "快去制作你的书单吧",
      ...
      sections: {
        ...
        new_book: {
          title: "最新作品",
          tab_latest_serial: "最新连载",
          tab_new_on_shelf: "最新上架",
          tab_recently_completed: "近期完结",
          more: "更多 \u2192",
        },
        trending_book: {
          title: "趋势好书",
    ...
    shelf: {
      ...
      move_up: "上移",
      move_down: "下移",
      update_success: "书架更新成功",
      delete_success: "书架删除成功",
      delete_failed: "书架删除失败",
      untitled: "（无标题）",
      list: {
        search_placeholder: "搜索书架",
      },
    },
  },
  ...
  auth: {
    ...
    flow: {
      new_to_app: "第一次来到 REZICS？",
      create_account: "创建账号",
      forgot_password: "忘记密码？",
      already_have_account: "已经有账号了？",
      sign_in_instead: "去登录",
      providers_divider: "或使用以下方式继续",
      providers_loading: "正在加载登录方式…",
      continue_with_provider: "使用 {{provider}} 继续",
      onboarding_title: "完成账号设置",
      onboarding_sign_in_first: "请先登录，再继续完成账号设置。",
      onboarding_social_only: "该页面仅用于社交登录账号的首次设置。",
      onboarding_complete: "你的账号设置已完成。",
      onboarding_intro:
        "社交登录账号需要先提供可用邮箱，系统才能将其视为可使用成员能力的账号。密码为可选项。",
      onboarding_trusted_email:
        "该邮箱已被你的登录提供方信任。如果改用其他邮箱，则需要重新验证。",
      onboarding_editable_email: "修改邮箱后，需要完成验证才能获得成员能力。",
      onboarding_optional_password:
        "如果你暂时只想使用社交登录，可以将密码留空。",
      onboarding_saved: "账号设置信息已保存。",
      onboarding_submit: "完成设置",
      onboarding_saving: "保存中…",
      verify_title: "验证邮箱",
      verify_sign_in_first: "请先登录，再继续邮箱验证。",
      verify_already_done: "你的邮箱已经验证完成。",
      verify_intro_prefix: "验证",
  ...
  search: {
    ...
    input: {
      placeholder: "书名、ISBN、作者、出版社、出品方",
      tags_label: "标签",
      tags_hint: "点击下方标签或输入标签，用逗号分隔",
      word_count_label: "字数",
