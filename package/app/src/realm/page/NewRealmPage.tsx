...
export function NewRealmPage() {
  ...
  return (
    <Box maxWidth="md" mx="auto" px={2} py={3}>
      <Typography variant="h5" fontWeight={600} mb={3}>New Realm</Typography>
      <Stack spacing={3}>
        ...
        <Stack direction="row" justifyContent="flex-end">
          <Button variant="contained" disableElevation onClick={handleCreate} disabled={!title || createMutation.isPending}>Create</Button>
        </Stack>
      </Stack>
    </Box>
  );
