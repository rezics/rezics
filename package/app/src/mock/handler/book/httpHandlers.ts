...
import { createBook, getBookById, listBooks, removeBook, updateBook } from "./service";
...
export const bookHttpHandlers = [
  ...
  http.post("/api/books", async ({ request }) => {
    ...
    const created = createBook({ title: body?.title ?? "Untitled Book", coverUrl: body?.coverUrl, isbn: body?.isbn });
