...
type $Auditable = $.ObjectType<
    ...
    | "default::User"
>;
const $Auditable = $.makeType<$Auditable>(_.spec, "0c664df6-752a-11f0-87e0-81dc294a19f9", _.syntax.literal);
...
type $Nameable = $.ObjectType<
    ...
    | "default::User"
>;
const $Nameable = $.makeType<$Nameable>(_.spec, "0c715f24-752a-11f0-94e1-4f347f7b0282", _.syntax.literal);

const Nameable: $.$expr_PathNode<$.TypeSet<$Nameable, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
type $Evaluable = $.ObjectType<
    ...
    | "default::User"
>;
const $Evaluable = $.makeType<$Evaluable>(_.spec, "0c730691-752a-11f0-bb97-d3a82601a5a9", _.syntax.literal);

const Evaluable: $.$expr_PathNode<$.TypeSet<$Evaluable, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
type $Relatable = $.ObjectType<
    ...
    | "default::User"
>;
const $Relatable = $.makeType<$Relatable>(_.spec, "0c742e30-752a-11f0-a21a-8f01f9f15526", _.syntax.literal);

const Relatable: $.$expr_PathNode<$.TypeSet<$Relatable, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $Author = $.makeType<$Author>(_.spec, "0cbbd34b-752a-11f0-8fcb-ed6e7a00f148", _.syntax.literal);

const Author: $.$expr_PathNode<$.TypeSet<$Author, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $Book = $.makeType<$Book>(_.spec, "0c76ad60-752a-11f0-a5a8-1d4a2bc46037", _.syntax.literal);

const Book: $.$expr_PathNode<$.TypeSet<$Book, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $Chapter = $.makeType<$Chapter>(_.spec, "0cc92e95-752a-11f0-8385-31c1884c2cb7", _.syntax.literal);

const Chapter: $.$expr_PathNode<$.TypeSet<$Chapter, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $ChapterOrder = $.makeType<$ChapterOrder>(_.spec, "0cc6a494-752a-11f0-af78-2fb4180f1657", _.syntax.literal);

const ChapterOrder: $.$expr_PathNode<$.TypeSet<$ChapterOrder, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $Identity = $.makeType<$Identity>(_.spec, "0c7ba51d-752a-11f0-bbe3-2955f0b5d7ea", _.syntax.literal);

const Identity: $.$expr_PathNode<$.TypeSet<$Identity, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $Person = $.makeType<$Person>(_.spec, "0c7d8388-752a-11f0-83a4-adeed2c3bf84", _.syntax.literal);

const Person: $.$expr_PathNode<$.TypeSet<$Person, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $Organization = $.makeType<$Organization>(_.spec, "0c82664b-752a-11f0-9148-352a7073cad0", _.syntax.literal);

const Organization: $.$expr_PathNode<$.TypeSet<$Organization, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $Publisher = $.makeType<$Publisher>(_.spec, "0cd2b783-752a-11f0-9c53-9b8e63c720b8", _.syntax.literal);

const Publisher: $.$expr_PathNode<$.TypeSet<$Publisher, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $Tag = $.makeType<$Tag>(_.spec, "0ca28ad6-752a-11f0-94bf-fdecbec4a52b", _.syntax.literal);

const Tag: $.$expr_PathNode<$.TypeSet<$Tag, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $Thread = $.makeType<$Thread>(_.spec, "0ca714bc-752a-11f0-a16b-9722566e7c29", _.syntax.literal);

const Thread: $.$expr_PathNode<$.TypeSet<$Thread, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
const $User = $.makeType<$User>(_.spec, "0c992001-752a-11f0-9e4f-e309cb17d960", _.syntax.literal);
