...
const long_str: $.scalarTypeWithConstructor<_std.$str, never> = $.makeType<$.scalarTypeWithConstructor<_std.$str, never>>(_.spec, "0c61c5a8-752a-11f0-a7bf-b54d80df958a", _.syntax.literal);

export type $short_str = $.ScalarType<"std::str", string>;
const short_str: $.scalarTypeWithConstructor<_std.$str, never> = $.makeType<$.scalarTypeWithConstructor<_std.$str, never>>(_.spec, "0c633f50-752a-11f0-831f-fd15d4b0c2f9", _.syntax.literal);
...
export { long_str, short_str, $Auditable, Auditable, $Nameable, Nameable, $Evaluable, Evaluable, $Relatable, Relatable, $Author, Author, $Book, Book, $Chapter, Chapter, $ChapterOrder, ChapterOrder, $Identity, Identity, $Person, Person, $Organization, Organization, $Publisher, Publisher, $Tag, Tag, $Thread, Thread, $User, User };
