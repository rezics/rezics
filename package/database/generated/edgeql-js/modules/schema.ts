...
import type * as _stdnethttp from "./std/net/http.ts";
import type * as _$default from "./default.ts";
...
export type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is Base]": $.LinkDesc<_$default.$Base, $.Cardinality.Many, {}, false, false,  false, false>;
