...
export namespace $default {
  ...
  export interface Tagable extends std.$Object {
    "tags": Nameable[];
  }
  export interface Author extends Nameable, Evaluable, Tagable {
    "description"?: string | null;
    "books": Book[];
    "user"?: Person | null;
  }
  export interface Book extends Nameable, Auditable, Evaluable, Tagable {
    "author": Author[];
    "length": bigint;
    "real_updated_at"?: Date | null;
  ...
  export interface CustomTag extends Nameable {
    "owner": Person;
  }
  export interface Person extends Nameable, Auditable, Evaluable, Tagable {
    "owned_favorites": Evaluable[];
    "owned_tags": CustomTag[];
  }
  export interface Organization extends Person {
    "members": Person[];
  }
  export interface Platform extends Nameable, Evaluable, Tagable {
    "domain": string;
    "books": Book[];
  }
  export interface Thread extends Nameable, Auditable, Evaluable, Tagable {
    "author": Person;
    "replies": Thread[];
    "content": string;
  }
  export interface Unit extends Nameable, Evaluable, Tagable {
    "order": number;
    "children": Unit[];
    "parent"?: Unit | null;
    "book"?: Book | null;
