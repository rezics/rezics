...
import type * as $ from "./reflection.mjs";
import * as literal from "./literal.mjs";
import type * as _std from "./modules/std.mjs";
import type * as _sys from "./modules/sys.mjs";
import type * as _stdpg from "./modules/std/pg.mjs";
import type * as _stdnethttp from "./modules/std/net/http.mjs";
import type * as _stdnet from "./modules/std/net.mjs";
import type * as _stdfts from "./modules/std/fts.mjs";
import type * as _stdenc from "./modules/std/enc.mjs";
import type * as _stdcal from "./modules/std/cal.mjs";
import type * as _schema from "./modules/schema.mjs";
import type * as _extpgvector from "./modules/ext/pgvector.mjs";
import type * as _extauth from "./modules/ext/auth.mjs";
import type * as _extai from "./modules/ext/ai.mjs";
import type * as _$default from "./modules/default.mjs";
...
export interface ScalarAssignableByMap {
  ...
  "ext::pgvector::vector": _extpgvector.$vectorλIAssignableBy;
  "ext::pgvector::sparsevec": _extpgvector.$sparsevecλIAssignableBy;
  "ext::pgvector::halfvec": _extpgvector.$halfvecλIAssignableBy;
  "ext::auth::WebhookEvent": _extauth.$WebhookEvent;
  "ext::auth::JWTAlgo": _extauth.$JWTAlgo;
  "ext::auth::FlowType": _extauth.$FlowType;
  "ext::ai::ProviderAPIStyle": _extai.$ProviderAPIStyle;
  "ext::ai::IndexType": _extai.$IndexType;
  "ext::ai::DistanceFunction": _extai.$DistanceFunction;
  "ext::ai::ChatParticipantRole": _extai.$ChatParticipantRole;
  "default::short_str": _$default.$short_str;
  "default::long_str": _$default.$long_str;
  "std::str": _std.$str;
...
export interface ScalarCastableFromMap {
  ...
  "schema::AccessPolicyAction": _schema.$AccessPolicyAction;
  "schema::AccessKind": _schema.$AccessKind;
  "ext::pgvector::vector": _extpgvector.$vectorλICastableTo;
  "ext::pgvector::sparsevec": _extpgvector.$sparsevec;
  "ext::pgvector::halfvec": _extpgvector.$halfvec;
  "ext::auth::WebhookEvent": _extauth.$WebhookEvent;
  "ext::auth::JWTAlgo": _extauth.$JWTAlgo;
  "ext::auth::FlowType": _extauth.$FlowType;
  "ext::ai::ProviderAPIStyle": _extai.$ProviderAPIStyle;
...
type getSharedParentScalar<A, B> =
  ...
  B extends $.ScalarType<infer BName> ?
    ...
    AName extends "std::bigint" ?
      ...
      never
    :
    AName extends "ext::pgvector::vector" ?
      BName extends "ext::pgvector::vector" ?
        B
      :
      BName extends "ext::pgvector::halfvec" ?
        A
      :
      never
    :
    AName extends "ext::pgvector::halfvec" ?
      BName extends "ext::pgvector::vector" ?
        B
      :
      BName extends "ext::pgvector::halfvec" ?
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::short_str") {
    if(b.__name__ === "default::short_str") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::long_str") {
    if(b.__name__ === "default::long_str") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
