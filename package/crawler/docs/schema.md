...
Defined in `src/schema.ts` using Zod, with a JSON Schema (Draft-7) exporter as the default export of the module.
...
The module’s default export is a function returning a JSON string of the Draft-7 JSON Schema for `Book`:
