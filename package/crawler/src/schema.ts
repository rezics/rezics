import { array, base64, boolean, iso, number, object, string, toJSONSchema, url, z, ZodType } from "zod/v4";
...
export default () => JSON.stringify(toJSONSchema(Book, { target: "draft-7" }), null, 4);
