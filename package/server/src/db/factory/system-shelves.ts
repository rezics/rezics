 ...
 * module would require server tsconfig path mappings during seed startup. This
 * copy stays inside db factory code and only depends on the storage client that
 * the seed already uses.
 */
