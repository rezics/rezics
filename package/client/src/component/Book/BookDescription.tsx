...
export const BookDescriptionShow: React.FC<BookDescriptionShowProps> = (
    { description, onEdit, showEditButton = true, editOpen, setEditOpen, bookId },
) => {
    ...
    return (
        <div>
            <Box>
                ...
                <Typography variant="body1" className="whitespace-pre-line">{description}</Typography>
            </Box>{" "}
...
export type BookDescriptionContainerProps = { description: string; bookId: string };
export const BookDescriptionContainer: React.FC<BookDescriptionContainerProps> = ({ description, bookId }) => {
...
export const BookDescriptionEditShow: React.FC<BookDescriptionEditShowProps> = (
...
import { safeApiPost } from "@/api/swr.ts";
...
export const BookDescriptionEditContainer: React.FC<BookDescriptionEditContainerProps> = (
    ...
    const onUpdate = async (newDesc: string) => {
        ...
        const result = await safeApiPost(updateBookInput);
        if (result === "error") {
