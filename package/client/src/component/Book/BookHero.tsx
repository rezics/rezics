...
import type { BookReadPartial } from "@/api/Book.ts";

export const BookHeroShow: React.FC<{ data: BookReadPartial }> = ({ data }) => {
    return (
        <div>
            <Box
...
export const BookHeroContainer: React.FC<Container> = ({ data }) => {
    return <BookHeroShow data={data} />;
};
