...
export const withBearer: Middleware = (useSWRNext) => <Data = any>(key: any, fetcher: any, config: any) => {
    ...
    return useSWRNext(key, wrappedFetcher, { ...config, shouldRetryOnError: false });
};
