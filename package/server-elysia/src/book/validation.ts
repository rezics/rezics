import type {CreateBookInput, UpdateBookInput} from '@package/contract';
 ...
 */
export function validateCreateBook(req: CreateBookInput): void {
 ...
 */
export function validateUpdateBook(req: UpdateBookInput): void {
