...
export const mockBlogPosts: MockBlogPost[] = [
    ...
    },
    {
        ...
        content:
            "Exploring the wonders of ancient Egypt, Rome, and Greece, from their majestic pyramids to their influential philosophies...",
        status: "PUBLISHED",
    ...
    },
    {
        ...
        content:
            "A deep dive into the techniques and tools used by digital artists to create stunning visuals, from concept sketches to finished masterpieces...",
        status: "DRAFT",
        categoryId: mockCategories[2].id,
        category: { id: mockCategories[2].id, title: mockCategories[2].title },
