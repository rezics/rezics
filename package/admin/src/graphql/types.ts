...
export type PostCreateMutation = {
    createOneBlogPost: Pick<Types.BlogPost, "id" | "title" | "status" | "content"> & {
...
export type PostEditMutation = {
    updateOneBlogPost: Pick<Types.BlogPost, "id" | "title" | "status" | "categoryId" | "content"> & {
...
export type GetVariables<Q extends Record<"input", any>> = Q["input"]["update"] extends object
    ? Q["input"]["update"]
