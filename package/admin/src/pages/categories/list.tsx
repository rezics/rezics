import { List, useTable, EditButton, DateField, getDefaultSortOrder, DeleteButton } from "@refinedev/antd";
    ...
    const { tableProps, sorters } = useTable<ICategory>({
        ...
        queryOptions: {
            retry(failureCount, error) {
                if (error?.message.includes("Network Error") && failureCount <= 3) return true;
                return false;
            },
        },
    });
