...
import type { CategoriesSelectQuery, PostCreateMutation, GetFields, GetFieldsFromList } from "graphql/types";
...
export const PostCreate = () => {
    ...
    const { selectProps: categorySelectProps } = useSelect<GetFieldsFromList<CategoriesSelectQuery>>({
        resource: "categories",
        metaData: {
