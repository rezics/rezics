    ...
    getHomePageFeed: {
        ...
        responses: {
            200: z.object({
                ...
                sections: z.object({
                    featuredBooks: z.array(z.object({
                        id: z.string(),
                        name: z.string(),
                    ...
                    trendingPosts: z.array(z.object({
                        id: z.string(),
                        title: z.string(),
                        authorName: z.string(),
                        excerpt: z.string(),
                    ...
                    recommendedReadlists: z.array(z.object({
                        id: z.string(),
                        name: z.string(),
                    ...
                    popularAuthors: z.array(z.object({
                        id: z.string(),
                        name: z.string(),
    ...
    getHomePageAnalytics: {
        ...
        responses: {
            200: z.object({
                ...
                sectionMetrics: z.record(z.string(), z.object({
                    views: z.number(),
                    clicks: z.number(),
                    engagementRate: z.number(),
                })),
                popularContent: z.array(z.object({
                    type: z.string(),
                    id: z.string(),
                    title: z.string(),
        ...
        body: z.object({
            ...
            preferences: z.object({
                ...
                contentTypes: z.array(z.enum([
                    "books", "reviews", "posts", "readlists", "authors"
                ])).optional(),
            }),
        }),
        responses: {
