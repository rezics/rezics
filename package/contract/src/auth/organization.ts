...
export type AcceptInvitationBody = (typeof acceptInvitationBodySchema)['static'];
...
export type UpdateMemberRoleBody = (typeof updateMemberRoleBodySchema)['static'];
...
export type OrganizationDetailResponse = (typeof organizationDetailResponseSchema)['static'];
