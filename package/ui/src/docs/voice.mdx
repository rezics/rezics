...
This page is the human-readable counterpart to the AI skill at `.claude/skills/rezics-design/voice.md`. Keep the two in sync when foundation voice rules change.
