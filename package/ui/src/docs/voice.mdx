...
<Unstyled>
  <Grid cols={3}>
    <Swatch
      ...
      cssVar="--rezics-sys-color-surface-canvas"
      value="var(--rezics-sys-color-surface-canvas)"
      description="Warm, off-white. The foundation of every app surface."
      invertText
    />
    <Swatch
      name="Warm stone (dark)"
      cssVar="--rezics-sys-color-surface-canvas (dark)"
      value="#1a1a18"
...
<Compare>
  <Dont caption="Playful chrome copy">
    <div style={{ fontFamily: fontFamilies.sans, fontSize: 14, color: "var(--rezics-sys-color-text-primary)" }}>
