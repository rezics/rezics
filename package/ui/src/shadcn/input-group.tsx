...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: this generic input wrapper is not a form fieldset.
    <div
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: this addon groups inline controls but is not a fieldset.
    // biome-ignore lint/a11y/useKeyWithClickEvents: click only focuses the sibling input; keyboard users can focus the input directly.
    <div
      role="group"
