  ...
  group "server" {
    ...
    task "migrate" {
      ...
      config {
        ...
        entrypoint   = ["/bin/sh", "-c"]
        args         = ["until cd /repo/packages/server && bunx drizzle-kit migrate 2>&1; do echo 'Waiting for database...'; sleep 2; done"]
      }
  ...
  group "auth" {
    ...
    task "migrate" {
      ...
      config {
        ...
        network_mode = "[[ var "network" . ]]"
        entrypoint   = ["/bin/sh", "-c"]
        args         = ["until cd /repo/packages/auth && bunx drizzle-kit migrate 2>&1; do echo 'Waiting for database...'; sleep 2; done"]
      }
  ...
  group "notify" {
    ...
    task "migrate" {
      ...
      config {
        ...
        network_mode = "[[ var "network" . ]]"
        entrypoint   = ["/bin/sh", "-c"]
        args         = ["until cd /repo/packages/notify && bunx drizzle-kit migrate 2>&1; do echo 'Waiting for database...'; sleep 2; done"]
      }
  ...
  group "reaction" {
    ...
    task "migrate" {
      ...
      config {
        ...
        network_mode = "[[ var "network" . ]]"
        entrypoint   = ["/bin/sh", "-c"]
        args         = ["until cd /repo/packages/reaction && bunx drizzle-kit migrate 2>&1; do echo 'Waiting for database...'; sleep 2; done"]
      }
  ...
  group "history" {
    ...
    task "migrate" {
      ...
      config {
        ...
        network_mode = "[[ var "network" . ]]"
        entrypoint   = ["/bin/sh", "-c"]
        args         = ["until cd /repo/packages/history && bunx drizzle-kit migrate 2>&1; do echo 'Waiting for database...'; sleep 2; done"]
      }
  ...
  group "ranking" {
    ...
    task "migrate" {
      ...
      config {
        ...
        network_mode = "[[ var "network" . ]]"
        entrypoint   = ["/bin/sh", "-c"]
        args         = ["until cd /repo/packages/ranking && bunx drizzle-kit migrate 2>&1; do echo 'Waiting for database...'; sleep 2; done"]
      }
